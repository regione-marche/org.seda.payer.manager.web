...
<!--
<xsl:variable name="CELL_FONT_SIZE">10pt</xsl:variable>
<xsl:variable name="CELL_LINE_HEIGHT">14pt</xsl:variable>
-->
<xsl:variable name="CELL_FONT_SIZE">8pt</xsl:variable>
<xsl:variable name="CELL_LINE_HEIGHT">12pt</xsl:variable>
...
<xsl:template match="column-heading[@indent]">
  ...
  <fo:block text-align="left" font-size="{$CELL_FONT_SIZE}" font-family="serif" line-height="{$CELL_LINE_HEIGHT}" space-before="0.5mm" space-after="0.5mm">
    <xsl:if test="@indent">
...
<xsl:template match="drill-expand | drill-collapse">
  <!--<input type="image" title="{@title}" name="{@id}" src="{$context}/{$payerpath}/{$imgpath}/{@img}.gif" border="0" width="9" height="9"/>-->
</xsl:template>

<xsl:template match="drill-other">
  <!--<img src="{$context}/{$payerpath}/{$payerpath}/{$imgpath}/{@img}.gif" border="0" width="9" height="9"/>-->
</xsl:template>

<!-- navigation: sort -->
<xsl:template match="sort">
  <!--<input name="{@id}" title="{@title}" type="image" src="{$context}/{$payerpath}/{$imgpath}/{@mode}.gif" border="0" width="9" height="9"/>-->
</xsl:template>

<xsl:template match="drill-through">
  <!--<input name="{@id}" title="{@title}" type="image" src="{$context}/{$payerpath}/{$imgpath}/drill-through.gif" border="0" width="9" height="9"/>-->
</xsl:template>
...
<xsl:template match="cell">
    <fo:table-cell border="solid black 0.5pt" padding="2pt" border-collapse="collapse"> <!--border-style="solid" border-width="0.2mm"> -->
        <xsl:call-template name="odd-even">
         ...
         <fo:block text-align="right" padding="2pt" font-size="{$CELL_FONT_SIZE}" font-family="serif" line-height="{$CELL_LINE_HEIGHT}" space-before="0.2mm" space-after="0.2mm" text-indent="1mm">
...
<xsl:template match="property[@name='arrow']">
  ...
  <span style="margin-left: 0.5ex">
    <img border="0" src="{$context}/{$payerpath}/{$imgpath}/arrow-{@value}.gif" width="10" height="10"/>
  </span>
  -->
</xsl:template>
...
<!--
  <span style="margin-left: 0.5ex">
    <img align="middle" src="{$context}/{$payerpath}/{$imgpath}/filter-{@value}.gif" width="53" height="14"/>
  </span>
  -->
</xsl:template>
