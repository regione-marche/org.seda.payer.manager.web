	...
	<s:table  border="1" cellspacing="0" cellpadding="3"  cssclass="seda-ui-datagrid">
		<s:thead>
			<s:tr cssclass="seda-ui-datagridrowpari">
				...
				<s:th cssclass="seda-ui-datagridheadercell">Cod.Fisc. Princ.</s:th>
...
<c:if test="${!empty listaPagamenti}">
	...
	<s:datagrid  viewstate="" cachedrowset="listaPagamenti" action="ricercaPagamentiDocumenti.do" border="1" usexml="true"  rowperpage="${applicationScope.rowsPerPage}">
		<s:action>
			<c:url value="ricercaPagamentiDocumenti.do">
		...
		<s:dgcolumn index="3" label="Ente"  asc="CENTA" desc="CENTD"></s:dgcolumn>
  	    ...
  	    <!-- EH3_CISECISE -->
		<s:dgcolumn label="I/S" asc="CISEA" desc="CISED" index="4" ></s:dgcolumn>
		...
		<!-- data pagamento -->
		<s:dgcolumn index="10" format="dd/MM/yyyy" label="Data Pag." asc="DMOVA" desc="DMOVD"></s:dgcolumn>
	...
	<s:div name="indietro" cssclass="divRicBottoni">
		<s:form name="ricercaPagamentiForm" action="documentoDettaglio.do" method="post" hasbtn1="false" hasbtn2="false" hasbtn3="false">
