	...
	<s:form name="discaricoForm" action="ricercaTributi.do" method="post" hasbtn1="false" hasbtn2="false" hasbtn3="false">
      ...
      <s:div
        ...
        <s:div
          ...
          cssclass="divRicTitle bold">Lista Tributi Discarico
							
        </s:div>

        <c:if test="${not empty listaTributiDiscarico}">
          <s:table
            border="1"
            cellspacing="0"
            cellpadding="3"
            ...
            <s:thead>
              <s:tr cssclass="seda-ui-datagridrowpari">
                <s:th cssclass="seda-ui-datagridheadercell text_align_right "> </s:th>
                <s:th cssclass="seda-ui-datagridheadercell ">Tributo</s:th>
                <s:th cssclass="seda-ui-datagridheadercell ">Anno Riferimento</s:th>
                <s:th cssclass="seda-ui-datagridheadercell ">IdDominio</s:th>
                <s:th cssclass="seda-ui-datagridheadercell text_align_right ">Carico</s:th>
                <s:th cssclass="seda-ui-datagridheadercell text_align_right ">Riscosso</s:th>
                <s:th cssclass="seda-ui-datagridheadercell text_align_right ">Residuo</s:th>
                <s:th cssclass="seda-ui-datagridheadercell text_align_right width-227px" >Discarico</s:th>

              </s:tr>
            </s:thead>
            <s:tbody>
              <c:forEach
                items="${listaTributiDiscarico}"
                var="u"
                varStatus="loop">

                <s:tr cssclass="seda-ui-datagridrowpari">
                  <s:td cssclass="seda-ui-datagridcell text_align_right">
                      ${u.progressivoTributo}
                  </s:td>

                  <s:td cssclass="seda-ui-datagridcell text_align_left">
                      ${u.codiceTributo}
                  </s:td>
                  ...
                  <s:td cssclass="seda-ui-datagridcell text_align_right">
                      ${u.impResiduo}
  								...
  								<s:td cssclass="seda-ui-datagridcell text_align_right">
                    <s:textbox
                      name="trib_${loop.index}_impDiscarico"
                      label=""
                      text="${u.impDiscarico}"
                      bdisable="${u.impDiscaricoDisabled||impDiscaricoDisabledAll}"
                      maxlenght="15"
     ...
     <%-- Messages --%>
      ...
      <br />
        ...
        <c:if test="${!salvaDisabled}">
	        <s:button
	          id="tx_button_salva2"
	          type="submit"
	          text="Salva"
	          onclick=""
	          cssclass="btnSalvaDiscarico"
	          validate="true" />
        </c:if>
