...
<script type="text/javascript">
	...
	<c:url value="" var="formParameters">
		...
		<c:if test="${!empty tx_provincia}">  
			<c:param name="tx_provincia">${tx_provincia}</c:param>
		</c:if>
		...
		<c:if test="${!empty documento}">  
			<c:param name="documento">${documento}</c:param>
		</c:if>
		<c:if test="${!empty data_ricezione_da_day}">  
			<c:param name="data_ricezione_da_day">${data_ricezione_da_day}</c:param>
		</c:if>
		<c:if test="${!empty data_ricezione_da_month}">  
			<c:param name="data_ricezione_da_month">${data_ricezione_da_month}</c:param>
		</c:if>
		<c:if test="${!empty data_ricezione_da_year}">  
			<c:param name="data_ricezione_da_year">${data_ricezione_da_year}</c:param>
		</c:if>
		<c:if test="${!empty data_ricezione_a_day}">  
			<c:param name="data_ricezione_a_day">${data_ricezione_a_day}</c:param>
		</c:if>
		<c:if test="${!empty data_ricezione_a_month}">  
			<c:param name="data_ricezione_a_month">${data_ricezione_a_month}</c:param>
		</c:if>
		<c:if test="${!empty data_ricezione_a_year}">  
			<c:param name="data_ricezione_a_year">${data_ricezione_a_year}</c:param>
		</c:if>
		<c:if test="${!empty esitoRim}">  
			<c:param name="esitoRim">${esitoRim}</c:param>
		</c:if>
		<c:if test="${!empty strumento}">  
			<c:param name="strumento">${strumento}</c:param>
		</c:if>
		<c:if test="${!empty data_ordine_da_day}">  
			<c:param name="data_ordine_da_day">${data_ordine_da_day}</c:param>
		</c:if>
		<c:if test="${!empty data_ordine_da_month}">  
			<c:param name="data_ordine_da_month">${data_ordine_da_month}</c:param>
		</c:if>
		<c:if test="${!empty data_ordine_da_year}">  
			<c:param name="data_ordine_da_year">${data_ordine_da_year}</c:param>
		</c:if>
		<c:if test="${!empty data_ordine_a_day}">  
			<c:param name="data_ordine_a_day">${data_ordine_a_day}</c:param>
		</c:if>
		<c:if test="${!empty data_ordine_a_month}">  
			<c:param name="data_ordine_a_month">${data_ordine_a_month}</c:param>
		</c:if>
		<c:if test="${!empty data_ordine_a_year}">  
			<c:param name="data_ordine_a_year">${data_ordine_a_year}</c:param>
		</c:if>
	</c:url>
	...
	<s:form name="ricercAnagraficheForm" action="ricercaAnagrafiche.do" method="post" hasbtn1="false" hasbtn2="false" hasbtn3="false">
...
<c:if test="${!empty listaEccedenze}">
	...
	<s:datagrid  viewstate="" cachedrowset="listaEccedenze" action="ricercaAnagrafiche.do" border="1" usexml="true"  rowperpage="${applicationScope.rowsPerPage}">
		<s:action>
	    ...
	    <s:dgcolumn label="Azioni ">
				<s:hyperlink href="eccedenzeDettaglio.do${formParameters}&tx_button_cerca=OK&chiaveEcc={13}" alt="Dettaglio Rimborso" text="Dett" cssclass="blacklink" />
        </s:dgcolumn>
