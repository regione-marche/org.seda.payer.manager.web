	...
	<s:datagrid  viewstate="" cachedrowset="dettaglioEmi" action="nessuna.do" border="1" usexml="true"  rowperpage="${applicationScope.rowsPerPage}">
       ...
       <!-- EH1_CEH1ADOC -->	
		...
		<s:div name="div_selezione" cssclass="div_align_center divSelezione">
				<s:form name="ricercaDettaglioEmiForm" action="ricercaEmissioni.do" method="post" hasbtn1="false" hasbtn2="false" hasbtn3="false">
				</s:form>
		</s:div>


<c:if test="${!empty documentiEmi}">
	<fmt:setLocale value="it_IT"/>
	...
	<s:div name="divDocumentiEmi" cssclass="divRisultati">

	<s:datagrid  viewstate="" cachedrowset="documentiEmi" action="ricercaDocumentiEmi.do" border="1" usexml="true"  rowperpage="${applicationScope.rowsPerPage}">
		<s:action>
			<c:url value="ricercaDocumentiEmi.do">
				<c:param name="test">ok</c:param>
				<c:if test="${!empty rRowsPerPage}">
					<c:param name="rRowsPerPage">${rRowsPerPage}</c:param>
				</c:if>
		...
		<!-- SOCIETA -->
		<s:dgcolumn index="1"  label="Soc." asc="SOCA" desc="SOCD"></s:dgcolumn>
	    ...
	    <s:dgcolumn label="Dett" >
	    	<s:hyperlink href="documentoDettaglio.do${formParameters}&tx_button_cerca_exp=OK&chiaveDoc={19}&chiaveServ={21}&chiaveTomb={22}&chiaveFlusso={20}&pagPrec=ricercaEmissioni" 
	    ...
	    <s:dgcolumn label="Tr" >
			...
			<s:then>
			{24}
			<s:hyperlink href="ricercaTributi.do${formParameters}&tx_button_cerca_exp=OK&chiaveDoc={19}&chiaveServ={21}&chiaveTomb={22}&chiaveFlusso={20}&pagPrec=ricercaEmissioni" 
	    ...
	    <s:dgcolumn label="Sc">
			...
			<s:then>
			{12}
			<s:hyperlink href="ricercaScadenze.do${formParameters}&tx_button_cerca_exp=OK&chiaveDoc={19}&chiaveServ={21}&chiaveTomb={22}&chiaveFlusso={20}&pagPrec=ricercaEmissioni" 
			             imagesrc="../applications/templates/shared/img/listaDati.png"
			             alt="Lista Scadenze"
			             text=""
			             cssclass="blacklink hlStyle" />
	    ...
	    <s:dgcolumn label="Pg">
			...
			<s:then>
			{25}
			<s:hyperlink href="ricercaPagamentiDocumenti.do${formParameters}&tx_button_cerca_exp=OK&chiaveDoc={19}&chiaveServ={21}&chiaveTomb={22}&chiaveFlusso={20}&pagPrec=ricercaEmissioni" 
			             imagesrc="../applications/templates/shared/img/listaDati.png"
			             alt="Lista Pagamenti"
			             text=""
			             cssclass="blacklink hlStyle" />
	...
	<table>
		<tr>
			<td>
				<s:form name="ricercaEmissioni" action="ricercaEmissioni.do" method="post" hasbtn1="false" hasbtn2="false" hasbtn3="false">
			...
			<td>		
				<s:form name="ricercaDocumentiEmi" action="ricercaDocumentiEmi.do?${formParametersDett}" method="post" hasbtn1="false" hasbtn2="false" hasbtn3="false">
	
						<c:if test="${!empty documentiEmi && ext=='0'}">
							<s:button id="tx_button_cerca_exp" type="submit" text="Espandi" onclick="" cssclass="btnStyle" />
						</c:if>
						<c:if test="${!empty documentiEmi && ext=='1'}">
