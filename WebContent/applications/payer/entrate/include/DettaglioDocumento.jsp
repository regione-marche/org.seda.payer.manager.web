	...
	<s:table  border="1" cellspacing="0" cellpadding="3"  cssclass="seda-ui-datagrid">
		...
		<s:tbody>
			...
			<s:tr cssclass="seda-ui-datagridrowpari">
				...
				--%>
				<s:td cssclass="seda-ui-datagridcell">num. Avviso pagoPA</s:td>
				<s:td cssclass="seda-ui-datagridcell">${numeroBollettino}</s:td>
			...
			<s:tr cssclass="seda-ui-datagridrowpari">
				...
				<s:td cssclass="seda-ui-datagridcell">${dettNumDocColl}</s:td>
				--%>
				<s:td cssclass="seda-ui-datagridcell">codice IUV</s:td>
				<s:td cssclass="seda-ui-datagridcell">${numeroIUV}</s:td>
				<%--<s:td cssclass="seda-ui-datagridcell" icol="2"></s:td>--%>
			</s:tr>
