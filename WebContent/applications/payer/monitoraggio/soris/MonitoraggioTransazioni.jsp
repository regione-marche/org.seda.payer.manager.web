				...
				<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">
					...
					<s:div name="divElement12" cssclass="divRicMetadatiSingleRow">
						...
						<s:dropdownlist name="tx_mostra" disable="false" cssclass="tbddl"
							...
							<%-- Giulia 17092013 --%>
							 ...
							 <%-- <s:ddloption value="3" text="Transazioni con successo e riversate" /> --%>
								
							<%-- <s:ddloption value="4" text="Transazioni con successo e non riversate" /> --%>
								
							<%-- <s:ddloption value="5" text="Transazioni con successo e non riversabili" /> --%>
					...
					<s:div name="divElement14a" cssclass="divRicMetadatiSingleRow">
						<s:textbox validator="ignore;" bmodify="true"
							name="tx_id_transaz_atm" label="Id.Trans.Atm:"
							text="${tx_id_transaz_atm}" maxlenght="49" cssclass="textareaman"
							cssclasslabel="label85 bold textright" />
					</s:div>
	...
	<s:div name="divRisultati" cssclass="divRisultati">
		<s:datagrid cachedrowset="tx_lista_transazioni"
			...
			<s:dgcolumn
				...
				secondright="{19}" secondcontrol="ne" secondleft="TSL">
					<s:then>
				...
				<!-- stato annullo == 2 -->
				<s:if right="{32}" control="eq" left="0" operator="or"
				secondright="{34}" secondcontrol="eq" secondleft="2">
					<s:then>
					</s:then>
					<s:else>
						<s:hyperlink href="../riconciliazionemt/dettaglioAssociazioniMovimentoCassa.do?idmdc={32}&page=monTra"
