	...
	<s:div name="div_table_trans">
		<s:table border="1" cellspacing="0"
			...
			<s:tbody>
				...
				<s:tr>
				    <s:td cssclass="seda-ui-cellheader" id="dt_chiave_transazione_Atm_Totem"></s:td>
					<s:td id="dt_chiave_transazione_Atm" icol="3"></s:td>
				</s:tr>
				<s:tr>
		...
		<s:table border="1" cellspacing="0"
			...
			<s:tbody id="dt_tbody_iv">
				...
				<s:tr cssclass="tipo_bollettino_SPO">
					...
					<s:td icol="3" id="spo_note_premarcato">comprensivo di Causale del Servizio, Anno Riferimento, Cespite </s:td>
				</s:tr>
				<s:tr>
