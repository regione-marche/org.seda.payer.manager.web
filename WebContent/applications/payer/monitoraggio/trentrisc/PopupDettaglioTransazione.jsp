			...
			<s:tbody>
				...
				<!--<c:if test="${!empty tx_lista_dettaglio}">
					<c:forEach items="${tx_lista_dettaglio}" var="tx_dettaglio" >
						<c:if test="${!empty tx_dettaglio.nodoSpcIuv}">
						<s:tr>
							<s:td cssclass="seda-ui-cellheader">Codice IUV:</s:td>
							<s:td id="dt_id_iuv" icol="2">${tx_dettaglio.nodoSpcIuv}</s:td>
							<s:td >
		...
		<s:table border="1" cellspacing="0"
			...
			<s:tbody id="dt_tbody_ici">
				...
				<s:tr cssclass="tipo_bollettino_ICIM">
					<s:td cssclass="seda-ui-cellheader">Abitazione Principale fattispecie assimilate e loro pertinenze:</s:td>
					<s:td cssclass="text_align_right"
				...
				<s:tr cssclass="tipo_bollettino_ICIM">
					<s:td cssclass="seda-ui-cellheader">Atri Fabbricati abitativi:</s:td>
					<s:td cssclass="text_align_right"
				...
				<s:tr cssclass="tipo_bollettino_ICIM">
					<s:td cssclass="seda-ui-cellheader">Aree Edificabili:</s:td>
					<s:td cssclass="text_align_right"
				...
				<s:tr cssclass="tipo_bollettino_ICIM">
					<s:td cssclass="seda-ui-cellheader">Sanzioni di Accertamento:</s:td>
					<s:td cssclass="text_align_right"
						id="ici_importo_detrazione_statale"></s:td>
					<s:td cssclass="seda-ui-cellheader">Interessi da Accertamento:</s:td>
					<s:td cssclass="text_align_right"
				...
				<s:tr cssclass="tipo_bollettino_ICIM">
					...
					<s:td cssclass="seda-ui-cellheader">Sanzioni ed Interessi da ravvedimento operoso:</s:td>
					<s:td cssclass="text_align_right"
						id="ici_interessi_ici_sanzioni"></s:td>
				...
				<s:tr cssclass="tipo_bollettino_ICIM">
					...
					<s:td id="ici_codice_fiscale"></s:td>
					 <s:td cssclass="seda-ui-cellheader"></s:td>
					<s:td cssclass="text_align_right"></s:td>
