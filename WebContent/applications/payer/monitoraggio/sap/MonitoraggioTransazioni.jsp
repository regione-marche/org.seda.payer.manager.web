	...
	<s:div name="divRicercaTopName" cssclass="divRicercaTop">
		<s:form name="monitoraggioTransazioniForm"
			...
			<s:div name="divRicercaBottoni" cssclass="divRicBottoni">
				...
				<c:if test="${!empty tx_lista_transazioni && userProfile!='AMEN'}">
		...
		<s:datagrid cachedrowset="tx_lista_transazioni"
			...
			<s:dgcolumn label="Id">
				<s:hyperlink
					...
					onclick="showDettaglio('dettaglioTransazioneJson.do?tx_codice_transazione_hidden={1}');return false"
			...
			<s:dgcolumn
				label="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Azioni&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
				<s:if right="{15}{21}" control="eq" left="1Y" operator="and"
				secondright="{27}" secondcontrol="ne" secondleft="Migrazione">
					<s:then>
				...
				<s:if right="{15}{21}" control="eq" left="1N" operator="and"
				secondright="{27}" secondcontrol="ne" secondleft="Migrazione">
					<s:then>
						<c:if test="${sessionScope.j_user_bean.azioniPerTransazioniOkEnabled}">
							<s:hyperlink
				...
				<s:if right="{15}{21}" control="eq" left="1X" operator="and"
				secondright="{27}" secondcontrol="ne" secondleft="Migrazione">
					<s:then>
						<c:if
				...
				<s:if right="{15}" control="eq" left="0" operator="and"
				secondright="{27}" secondcontrol="ne" secondleft="Migrazione">
					<s:then>
						<c:if
				...
				<s:if right="{15}{20}" control="eq" left="0M" operator="and"
				secondright="{27}" secondcontrol="ne" secondleft="Migrazione">
					<s:then>
						<c:if
...
<!-- non riconciliata - stato successo - agganciata a flusso fittizio -->
				<s:if right="{12}{15}{24}" control="eq" left="NO1N" operator="and"
				secondright="{27}" secondcontrol="ne" secondleft="Migrazione">
					<s:then>
