	...
	<s:div name="divRisultati" cssclass="divRisultati">
		<s:datagrid cachedrowset="tx_lista_transazioni"
			...
			<s:dgcolumn
				...
				<%-- fine stato annullo 0 --%>
				<%-- inizio stato annullo 1 --%>
				...
				<%-- fine stato annullo 1 --%>
				<%-- inizio stato annullo =/= 2 --%>
				<s:if right="{32}" control="eq" left="0" operator="or"
				secondright="{34}" secondcontrol="ne" secondleft="2">
					<s:then>
					</s:then>
					<s:else>
