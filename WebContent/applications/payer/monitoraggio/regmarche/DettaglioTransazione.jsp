		...
		<s:table border="1" cellspacing="0" cssclass="seda-ui-datagrid tableDettaglio1">
			...
			<s:tbody>
				...
				<s:tr>
					...
					<s:td cssclass="seda-ui-cellheader">Numero tentativi pagamento:</s:td>
					<s:td>${tx_transazione.numero_tentativi_pagamento}</s:td>			
				</s:tr>	
				<s:tr>
		...
		<c:forEach items="${tx_lista_dettaglio}" var="tx_dettaglio" >
		    <s:table border="1" cellspacing="0" cssclass="seda-ui-datagrid tableDettaglio2" >
				...
				<s:tbody>
					...
					<c:choose>
						<c:when test="${tx_dettaglio.importoMarcaDaBolloDigitale > 0}">
								<s:tr>
							...
							<s:tr>
								<s:td cssclass="seda-ui-cellheader">Importo marca da bollo digitale:</s:td>
								<s:td cssclass="text_align_right"><fmt:formatNumber type="NUMBER" value="${tx_dettaglio.importoMarcaDaBolloDigitale}" minFractionDigits="2" maxFractionDigits="2"/></s:td>
								<s:td icol="2"></s:td>
							</s:tr>
						</c:when>
						<c:otherwise>
