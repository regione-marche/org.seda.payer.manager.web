					...
					<s:div name="divRicMetadati" cssclass="divRicMetadati">
						...
						<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
							...
							<s:div name="divElementLabel8a" cssclass="divTitle">
								<center>
								<s:label name="102" text="Giornali di cassa"  cssclass="lblTitlePadding bold"/>
								</center>
							</s:div>
							<s:div name="divElement100" cssclass="divRicMetadatiSingleRow">
								<s:dropdownlist label="Attiva GDC:" 
										cssclasslabel="label85 bold textright" cssclass="textareaman" 
										name="ente_flagGDC" disable="false"  
										validator="required" showrequired="true"
								    	valueselected="${ente_flagGDC}">
							    	<s:ddloption text="Selezionare uno degli elementi" value="" />
							...
							<s:div name="divElement101" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
									validator="ignore;accept=^[\\a-zA-Z0-9:_/\\.]{1,50}$"
									maxlenght="50"
									label="Path GDC.:" name="ente_dirGDCInput"
									text="${ente_dirGDCInput}"
									message="[accept=GDC Path Rimb.: ${msg_configurazione_directory_ftp}]"
									cssclasslabel="label85 bold textright" cssclass="textareaman" />
							</s:div>
							<s:div name="divElement102" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
									validator="ignore;accept=^[\\a-zA-Z0-9:_/\\.]{1,50}$"
									maxlenght="50"
									label="Path Save:" name="ente_dirGDCSave"
									text="${ente_dirGDCSave}"
									message="[accept=GDC Path Save: ${msg_configurazione_directory_ftp}]"
									cssclasslabel="label85 bold textright" cssclass="textareaman" />
							</s:div>
							<s:div name="divElement103" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
									validator="ignore;accept=^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/)?[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$"
									maxlenght="256"
									label="Endpoint UniIT:" name="ente_endpointUniit"
									text="${ente_endpointUniit}"
									message="[accept=GDC Endpoint UniIT: ${msg_configurazione_httpEndpoint}]"
									cssclasslabel="label85 bold textright" cssclass="textareaman" />
						...
						<s:div name="divElement97" cssclass="divRicMetadatiSingleRow">	
							...
							<s:div name="divElement45a" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
									validator="maxlength=35"
									maxlenght="35" showrequired="true"
									label="CodIpaEnte:" name="ente_codIpaEnte"
									text="${ente_codIpaEnte}"
									cssclasslabel="label85 bold textright" cssclass="textareaman" />
								
							</s:div>
							<s:div name="divElement46a" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
									validator="maxlength=15"
									maxlenght="15" showrequired="true"
									label="Pwd Ente:" name="ente_passwordEnte"
									text="${ente_passwordEnte}"
									cssclasslabel="label85 bold textright" cssclass="textareaman" />
							</s:div>
							<s:div name="divElement47a" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
									validator="maxlength=64;"
									maxlenght="64" showrequired="true"
									label="Pwd Sha256:" name="ente_passwordSha256Ente"
...
<!--  inizio LP 20180628 -->
							<s:div name="divElementLabel20" cssclass="divTitle">
								<center>
								<s:label name="prova20" text="Rendicontazione Flusso Nodo"  cssclass="lblTitlePadding bold"/>
								</center>
							</s:div>
							<s:div name="divElement720" cssclass="divRicMetadatiSingleRow">
								<s:dropdownlist label="Invio:" 
										cssclasslabel="label85 bold textright" cssclass="textareaman" 
										name="ente_flagFlussoRendicontazioneNodo" disable="false"  
										validator="ignore" showrequired="true"
								    	valueselected="${ente_flagFlussoRendicontazioneNodo}">
								    	<s:ddloption text="Selezionare uno degli elementi" value="" />
										<s:ddloption value="" text="Non Previsto"/>
										<s:ddloption value="E" text="Tramite EMail"/>
										<s:ddloption value="W" text="Tramite WebService"/>
								</s:dropdownlist>
							</s:div>
							<s:div name="divElement721" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
									validator="ignore;accept=${configurazione_emailListBySemicolon};maxlength=256"
									message="[accept=Lista Email: ${msg_configurazione_lista_email}]"
									maxlenght="256"
									label="Lista Email:" name="ente_listaEmailFlussoRendicontazioneNodo"
									text="${ente_listaEmailFlussoRendicontazioneNodo}"
									cssclasslabel="label85 bold textright" cssclass="textareaman" />
							</s:div>
							<s:div name="divElement722" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
								    validator="ignore;accept=^[\\a-zA-Z0-9:_/\\.]{1,256}$"
									maxlenght="256"
									label="Url WS:" name="ente_urlWebServiceFlussoRendicontazioneNodo"
									text="${ente_urlWebServiceFlussoRendicontazioneNodo}"
									cssclasslabel="label85 bold textright" cssclass="textareaman" />
							</s:div>
<!--  fine LP 20180628 -->
					...
					<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
						...
						<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">
							...
							<s:div name="divElement45a" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
									validator="maxlength=35"
									maxlenght="35" showrequired="false"
									label="CodIpaEnte:" name="ente_codIpaEnte"
									text="${ente_codIpaEnte}"
									cssclasslabel="label85 bold textright" cssclass="textareaman" />
							...
							<s:div name="divElement46a" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
									validator="maxlength=15"
									maxlenght="15" showrequired="false"
									label="Pwd Ente:" name="ente_passwordEnte"
									text="${ente_passwordEnte}"
									cssclasslabel="label85 bold textright" cssclass="textareaman" />
							</s:div>
							<s:div name="divElement47a" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
									validator="maxlength=64;accept=^[a-zA-Z0-9]{0,64}$"
									maxlenght="64" showrequired="false"
									label="Pwd Sha256:" name="ente_passwordSha256Ente"
									text="${ente_passwordSha256Ente}"
									message="[accept=Pwd Sha256: ${msg_configurazione_alfanumerici}]"
									cssclasslabel="label85 bold textright" cssclass="textareaman" />
...
<!--  inizio LP 20180628 -->
							<s:div name="divElementLabel21" cssclass="divTitle">
								<center>
								<s:label name="prova21" text="Rendicontazione Flusso Nodo"  cssclass="lblTitlePadding bold"/>
								</center>
							</s:div>
							<s:div name="divElement750" cssclass="divRicMetadatiSingleRow">
								<s:dropdownlist label="Invio:" 
										cssclasslabel="label85 bold textright" cssclass="textareaman" 
										name="ente_flagFlussoRendicontazioneNodo" disable="false"  
										validator="ignore" showrequired="true"
							...
							<s:div name="divElement751" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
									validator="ignore;accept=${configurazione_emailListBySemicolon};maxlength=256"
									message="[accept=Lista Email: ${msg_configurazione_lista_email}]"
									maxlenght="256"
							...
							<s:div name="divElement752" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
								    validator="ignore;accept=^[\\a-zA-Z0-9:_/\\.]{1,256}$"
									maxlenght="256"
									label="Url WS:" name="ente_urlWebServiceFlussoRendicontazioneNodo"
