				...
				<s:form name="frmAction" hasbtn3="false" hasbtn2="false"
					...
					<s:div name="divRicMetadati" cssclass="divRicMetadati">				
						...
						<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
							...
							<s:div name="divElement8" cssclass="divRicMetadatiSingleRow">
									<s:list bradio="false" bchecked="${chk_flagPagoPA}" validator="ignore" 
									 cssclasslabel="bold checklabel label150"  cssclass="checkleft"
									name="flagPagoPA" groupname="flagPagoPA" 
									text="Flag PagoPA" value="Y" />
							</s:div>

							<s:div name="divElement8a" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true" validator="maxlength=64" maxlenght="64"
									label="Tipo Dovuto:" name="configutentetiposervizioente_tipoDovuto"
									text="${requestScope.configutentetiposervizioente_tipoDovuto}"
									cssclasslabel="label85 bold textright" cssclass="textareaman" />
							</s:div>
							
							<%-- inizio SB PG210050 --%>
							<c:if test="${fn:substring(configutentetiposervizioente_tipoBol,0,4) == 'SPOM'}">
							<%-- stampa avviso pagopa auto prodotto abilitata --%>
							<s:div name="divElement932" cssclass="divRicMetadatiSingleRow">
								<s:dropdownlist label="Stampa avviso PagoPA:" 
										...
										<s:ddloption value="N" text="No"/>
										<s:ddloption value="Y" text="Si"/>
										<s:ddloption value="C" text="Configurazione"/> <%-- Anche per aosta devo rimanere questa opzione--%>
								</s:dropdownlist>
							</s:div>
						...
						<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">
							...
							<s:div name="divElement932" cssclass="divRicMetadatiSingleRow">
								<s:dropdownlist label="Giorni scadenza:" 
										...
										<s:ddloption value="5" text="5 gg"/>
										<s:ddloption value="10" text="10 gg"/>
										<s:ddloption value="15" text="15 gg"/>
