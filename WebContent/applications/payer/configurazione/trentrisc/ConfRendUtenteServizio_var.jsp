		...
		<s:form name="var_form" action="${do_command_name}" method="post"
			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
					...
					<s:div name="divElement164" cssclass="divRicMetadatiSingleRow">
						<s:list bradio="false" bchecked="${chk_flagTrcComandiPolizia}"
							validator="ignore" cssclasslabel="bold checklabel label200"
							cssclass="checkleft" name="flagTrcComandiPolizia" disable="false"
							groupname="flagTrcComandiPolizia" text="Tracciato Comandi Polizia" value="Y"
							onclick="" />
					</s:div>
