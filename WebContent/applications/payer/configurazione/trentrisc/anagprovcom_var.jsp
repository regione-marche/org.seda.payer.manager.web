				...
				<s:form name="frmAction" hasbtn3="false" hasbtn2="false"
					...
					<s:div name="divRicMetadati" cssclass="divRicMetadati">
						...
						<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
							...
							<s:div name="divElement82" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
									validator="ignore;accept=^[0-9 ]{1,6}$"
									maxlenght="6" 
									label="Cod. Istat:" name="anagprovcom_codiceIstat"
									text="${anagprovcom_codiceIstat}"
									message="[accept=Cod. Istat: ${msg_configurazione_codiceistat}]"
									cssclasslabel="label85 bold textright" cssclass="textareaman" />
							</s:div>
							
							<s:div name="divElement13" cssclass="divRicMetadatiSingleRow">
								<s:list bradio="false" bchecked="${anagprovcom_flagComuneAssociato}" validator="ignore;" 
						 			cssclasslabel="bold checklabel" cssclass="checkleft"
									name="anagprovcom_flagComuneAssociato" groupname="anagprovcom_flagComuneAssociato" 
									text="Com. Assoc." value="Y" />
							</s:div>
					...
					<s:div name="divRicercaMetadatiTop" cssclass="divRicMetadatiTop">
						...
						<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
							...
							<s:div name="divElement82" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
									validator="ignore;accept=^[0-9 ]{1,6}$" maxlenght="6" 
									label="Cod. Istat:" name="anagprovcom_codiceIstat"
									text="${anagprovcom_codiceIstat}"
									message="[accept=Cod. Istat: ${msg_configurazione_codiceistat}]"
									cssclasslabel="label85 bold textright" cssclass="textareaman" />
