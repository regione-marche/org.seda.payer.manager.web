				...
				<s:form name="frmAction" hasbtn3="false" hasbtn2="false"
					...
					<s:div name="divRicMetadati" cssclass="divRicMetadati">
						...
						<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
							...
							<s:div name="divElementLabel2" cssclass="divTitle">
								<center>
								<s:label name="GDC" text="Giornali di cassa"  cssclass="lblTitlePadding bold"/>
								</center>
							</s:div>
							
							<s:div name="divElement113" cssclass="divRicMetadatiSingleRow">
							...
							<s:div name="divElement145" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
									validator="ignore;accept=^[\\a-zA-Z0-9:_/\\.]{1,50}$"
									maxlenght="50"
							...
							<s:div name="divElement146" cssclass="divRicMetadatiSingleRow">
								<s:textbox bmodify="true"
									validator="ignore;accept=^[\\a-zA-Z0-9:_/\\.]{1,50}$"
									maxlenght="50"
...
<!--  inizio LP PG210040 -->
							<s:div name="divElement714B" cssclass="divRicMetadatiSingleRow">
								<s:dropdownlist name="ente_codiceGruppo"
										disable="false" label="Gruppo:"
										cssclasslabel="label85 bold textright" cssclass="textareaman" 
										cachedrowset="gruppi" usexml="true"
										validator="ignore" showrequired="false"
										valueselected="${ente_codiceGruppo}">
										<s:ddloption text="Selezionare uno degli elementi" value="" />
										<s:ddloption value="{2}" text="{3}"/>
								</s:dropdownlist>
							</s:div>
<!--  fine LP PG210040 -->
<!-- dom -->
...
<!--  inizio LP PG210040 -->
							<s:div name="divElement739B" cssclass="divRicMetadatiSingleRow">
								<s:dropdownlist name="ente_codiceGruppo"
										disable="false"
										label="Gruppo:"
										cssclasslabel="label85 bold textright" cssclass="textareaman" 
