...
<script type="text/javascript">
	...
	function caricoOnClick() {
		...
		if(senzaCaricoCB.checked){ 
			...
			//rendicontazioneSedaCB.checked = false;
			...
			servizioCB.disabled=true;
			enteCB.disabled=true; 
			codTributoCB.disabled=true;
	...
	function caricoForm() {
		...
		var bInvioFtp = invioFtpCB.checked;
		rendicontazioneSedaOnClick();
		invioFtpCB.checked = bInvioFtp;
	}
	...
	<s:div name="divRicercaTopName" cssclass="divRicercaTop">
		<s:form name="var_form" action="${do_command_name}" method="post"
			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<s:div name="divRicMetadatiTop" cssclass="divRicMetadatiTop">
					<s:div name="top">
						<s:dropdownlist name="ddlSocietaUtenteServizio"
							...
							valueselected="${ddlSocietaUtenteServizio}" validator="required"
							showrequired="true">
				...
				<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
					...
					<s:div name="divElement50" cssclass="divRicMetadatiSingleRow">
						<s:list bradio="false" bchecked="${chk_invioEmail}"
							validator="ignore" cssclasslabel="bold checklabel label85"
							cssclass="checkleft" name="invioEmail" groupname="invioEmail"
					...
					<s:div name="divElement51" cssclass="divRicMetadatiSingleRow">
						<s:list bradio="false" bchecked="${chk_invioFtp}"
							validator="ignore" cssclasslabel="bold label85 checklabel"
							cssclass="checkleft" name="invioFtp" groupname="invioFtp"
							text="Invio Ftp" value="Y" disable="${disabled_invioFtp}" />
					</s:div>
				
					<!-- RES_FRESAWBS FLAG ABILITAZIONE INVIO WEBSERVICE -->
					...
					<s:div name="divElement52" cssclass="divRicMetadatiSingleRow">
						...
						text="invio Web Service" value="Y" disable="${disabled_invioWebService}" />
					</s:div>
					...
					<c:if test="${not disabled_invioFtp}">
						<input type="hidden" id="invioFtpHidden" name="invioFtpHidden"
							value="Y" />
					</c:if>
					...
					<s:div name="divElement52" cssclass="divRicMetadatiSingleRow">
						<s:list bradio="false" bchecked="${chk_rendicontazioneSeda}"
							validator="ignore" cssclasslabel="bold checklabel label200"
							cssclass="checkleft" name="rendicontazioneSeda"
							groupname="rendicontazioneSeda"
							text="Rendicontazione Gestionale Entrate" value="Y"
							onclick="rendicontazioneSedaOnClick();" />
					...
					<s:div name="divElement15" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="emailAttachMaxSizeKb"
							...
							validator="ignore;digits;minlength=1;maxlength=5"
				...
				<s:div name="divElementLabel21" cssclass="divTitle">
					...
					<s:div name="divElement17" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="emailDestinatario"
							...
							cssclasslabel="label85 bold textright" cssclass="textareaman"
							validator="ignore;maxlength=256;accept=${configurazione_emailListBySemicolon}"
					...
					<s:div name="divElement18" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="emailCCN" label="Email CCN:"
							maxlenght="100" cssclasslabel="label85 bold textright"
					...
					<s:div name="divElement19" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="emailMittente"
							...
							cssclasslabel="label85 bold textright" cssclass="textareaman"
							validator="ignore;maxlength=100;accept=${configurazione_email_regex}"
				...
				<s:div name="divRicercaRight" cssclass="divRicMetadatiRight">
					...
					<s:div name="divElement161" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="utenteFtp"
							...
							cssclasslabel="label85 bold textright" cssclass="textareaman"
							validator="ignore;accept=^[\w\_\.\-\/\\\]{1,50}$"
					...
					<s:div name="divElement162" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" bpassword="true" name="passwordFtp"
							...
							cssclasslabel="label85 bold textright" cssclass="textareaman"
							validator="ignore;minlength=3;maxlength=20" text="${passwordFtp}" />
					</s:div>
					...
					<s:div name="divElementLabel22" cssclass="divTitle">
						<center>
					...
					<s:div name="divElement161" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="servizio"
							...
							cssclasslabel="label85 bold textright" cssclass="textareaman"
							validator="ignore;accept=^[\w]{0,2}$" bdisable="${disableCarico}"
					...
					<s:div name="divElement161" cssclass="divRicMetadatiSingleRow">
						...
						<s:textbox bmodify="true" name="ente" label="Ente:"
							...
							cssclass="textareaman"
							validator="ignore;accept=^[\w]{0,6}$" bdisable="${disableCarico}"
							message="[accept=Utente Ftp: ${msg_configurazione_descrizione_1}]"
							text="${ente}" />
					</s:div>
				</s:div>
			...
			<s:div name="divRicercaBottoni" cssclass="divRicBottoni">
				...
				<c:if test="${codop == 'add'}">
					<s:button id="tx_button_aggiungi" onclick="" text="Salva"
						type="submit" cssclass="btnStyle" />
				</c:if>
				<c:if test="${codop == 'edit'}">
					<s:button id="tx_button_edit" onclick="" text="Salva" type="submit"
						cssclass="btnStyle" />
				</c:if>
			</s:div>
			...
			<input type="hidden" name="tx_codiceTipologiaServizio"
				value="${tx_codiceTipologiaServizio}" />
		</s:form>
	</s:div>
