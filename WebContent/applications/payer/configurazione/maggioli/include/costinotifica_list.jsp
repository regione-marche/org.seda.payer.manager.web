...
<%-- 			<s:action>
			...
			<s:dgcolumn label="Azioni">
				  <s:hyperlink
					cssclass="hlStyle" 
					href="costinotifica.do?action=edit&costiNotifica_costiNotificaCompanyCode={1}&costiNotifica_costiNotificaUserCode={2}"
					imagesrc="../applications/templates/configurazione/img/edit.png"
					alt="Modifica" text="" />

				   <s:hyperlink
					cssclass="hlStyle" 
					href="costinotifica.do?action=richiestacanc&richiestacanc=y&costiNotifica_costiNotificaCompanyCode={1}&costiNotifica_costiNotificaUserCode={2}"
