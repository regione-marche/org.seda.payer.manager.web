...
-->
			...
			-->
				...
				<s:hyperlink href="insUpdAssocImpBenStart.do${formParameters}&tx_button_edit=ok&tastoUpd=ok&codSocieta={1}&codUtente={4}&codImpositore={2}&codTipologiaServizio={3}&annoRifDa={12}&annoRifA={13}&dataValidita={14}&codSocietaBen={22}&codUtenteBen={23}&codBeneficiario={18}" 
					imagesrc="../applications/templates/configurazione/img/edit.png"
					text="" cssclass="hlStyle" />
				<s:hyperlink href="cancAssocImpBenStart.do${formParameters}&tx_button_delete=ok&tastoDel=ok&codSocieta={1}&codUtente={4}&codImpositore={2}&codTipologiaServizio={3}&annoRifDa={12}&annoRifA={13}&dataValidita={14}&codSocietaBen={22}&codUtenteBen={23}&codBeneficiario={18}" 
