...
<%-- 		<s:dgcolumn index="3" label="Ente" /> --%>
			...
			<s:dgcolumn label="Azioni">
				<s:hlpost name="test" cssclass="hlPost" href="anagente.do?action=edit" 
				imgsrc="../applications/templates/configurazione/img/edit.png" alt="edit">
					<s:hlpostparam name="anagente_chiaveEnte" value="{1}"/>
				</s:hlpost>
<%-- 			<s:hyperlink --%>
<%-- 				cssclass="hlStyle"  --%>
...
<%-- 				hasbtn1="false" method="post" action="anagente.do?action=edit"> --%>
<!-- 				<input type="hidden" name="anagente_chiaveEnte" value="{1}"/> -->
<%-- 				<s:button id="tx_button_edit" onclick="" --%>
<%-- 							cssclass="hlStyle edit" type="submit" text=""/> --%>
<%-- 			</s:form> --%>
