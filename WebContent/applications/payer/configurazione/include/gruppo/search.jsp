			...
			<s:div name="divRicercaMetadatiName" cssclass="divRicMetadatiTop">
				...
				<s:div name="divElement2" cssclass="divRicMetadatiCenter">
					<s:textbox bmodify="true"
						...
						cssclasslabel="label85 bold textright"
						cssclass="textareaman" validator="ignore;accept=${configurazione_descrizioneGruppo100_regex}"
						message="[accept=Descrizione: ${msg_configurazione_descrizioneGruppo_regex}]"
