...
--%>
		        ...
		        <s:div name="divRicercaMetadatiLeft" cssclass="divRicMetadatiLeft">
					...
					<s:dropdownlist label="Tipo Gateway" name="gatewaypagamento_tipoGateway" disable="false" cssclasslabel="label85 bold textright"
						...
						<s:ddloption value="B" text="Unicredit - MyBank"/>
						<s:ddloption value="N" text="Nodo dei Pagamenti-SPC"/>
						<s:ddloption value="Y" text="Satispay"/>
					</s:dropdownlist>
					</s:div>
					...
					<s:div name="divElement9_1" cssclass="divRicMetadatiSingleRow">
						<s:dropdownlist label="Img Logo" name="gatewaypagamento_pathImgLogo" disable="false" cssclasslabel="label85 bold textright"
							  ...
							  valueselected="${requestScope.gatewaypagamento_pathImgLogo}">
								...
								<s:ddloption value="PagOnline_Visa.png" text="Logo Unicredit - PagOnline Visa"/>
								<s:ddloption value="PagOnline_Mastercard.png" text="Logo Unicredit - PagOnline MasterCard"/>
								<s:ddloption value="PagOnline_DinersClub.png" text="Logo Unicredit - PagOnline Diners"/>
								...
								<s:ddloption value="MyBank.png" text="Logo MyBank"/>
								<s:ddloption value="NodoSPC.png" text="Nodo dei Pagamenti-SPC"/>
								<s:ddloption value="Satispay.png" text="Satispay"/>
						</s:dropdownlist>
					</s:div>
