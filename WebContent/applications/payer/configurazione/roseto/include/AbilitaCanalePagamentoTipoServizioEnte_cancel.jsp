...
<m:view_state id="AbilitaCanalePagamentoTipoServizioEnte_cancel" encodeAttributes="true" />


<s:div name="div_delete" cssclass="div_align_center divSelezione">
	<s:div name="divDeleteTopName" cssclass="divRicercaTop">
	<s:form name="delete_form" action="AbilitaCanalePagamentoTipoServizioEnteCancel.do" method="post"
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
		<s:div name="divRicercaTitleName" cssclass="divRicTitle">
		ABILITAZIONE PER CANALE PAGAMENTO - TIPOLOGIA SERVIZIO - ENTE
		</s:div>
		<br/>
		<br/>
