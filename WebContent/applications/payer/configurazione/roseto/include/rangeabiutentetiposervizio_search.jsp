	...
	<c:if test="${rangeabiutentetiposervizios != null}">
		...
		<s:datagrid viewstate="true" cachedrowset="rangeabiutentetiposervizios"  
			...
			<s:dgcolumn label="Azioni">
				<s:hyperlink
					cssclass="hlStyle" 
					href="rangeabiutentetiposervizio_edit.do?action=edit&rangeabiutentetiposervizio_chiaveRangeTipoServizio={1}"
					imagesrc="../applications/templates/configurazione/img/edit.png"
					alt="Modifica" text="" />

   				<s:hyperlink
					cssclass="hlStyle" 
					href="rangeabiutentetiposervizio_cancel.do?action=richiestacanc&richiestacanc=y&chiaveRangeTipoServizio={1}"
