	...
	<s:datagrid cachedrowset="listaTemplate" border="0" rowperpage="${applicationScope.rowsPerPage}" 
		...
		<s:dgcolumn label="&nbsp;&nbsp;&nbsp;&nbsp;Azioni&nbsp;&nbsp;&nbsp;&nbsp;">
			<s:hyperlink cssclass="hlStyle" 
						 href="templateReportDinamici.do?action=edit&templatereportdinamici_chiaveTemplate={14}"
						 imagesrc="../applications/templates/configurazione/img/edit.png"
						 alt="Modifica" text="" />
			<s:hyperlink cssclass="hlStyle" 
					     href="templateReportDinamici.do?action=richiestacanc&richiestacanc=y&templatereportdinamici_chiaveTemplate={14}"
