...
<c:choose>
	<c:when test="${done == null && richiestacanc == null}">	
		<s:div name="divRicercaTopName" cssclass="divRicercaTop">
			<s:div name="divRicercaTitleName" cssclass="divRicTitle">Funzione Pagamento Utente - Tipologia Servizio</s:div>
		

			<s:form name="frmAction" hasbtn3="false" hasbtn2="false"
				hasbtn1="false" btn1text="..." btn1onclick="this.form.submit();"
				method="post" action="funzpagutentetiposervizio.do">
				...
				<s:div name="divRicercaTitleName1" cssclass="divRicMetadati">
					<s:div name="divRicercaMetadatiTop" cssclass="divRicMetadatiTop">		
						...
						<input type="hidden" name="funzpagutentetiposervizio_userCode" value="${funzpagutentetiposervizio_userCode}" />
						<input type="hidden" name="funzpagutentetiposervizio_companyCode" value="${funzpagutentetiposervizio_companyCode}" />
						<input type="hidden" name="funzpagutentetiposervizio_codiceTipologiaServizio" value="${funzpagutentetiposervizio_codiceTipologiaServizio}" />
						<input type="hidden" name="funzpagutentetiposervizio_tipoboll" value="${funzpagutentetiposervizio_tipoboll}" />				
						<c:choose>
							<c:when test="${action == 'edit' || action == 'saveedit'}">
								<input type="hidden" name="codop" value="${typeRequest.editScope}" />
								
								<s:dropdownlist name="ddlSocUteServ"  
									...
									valueselected="${funzpagutentetiposervizio_companyCode}|${funzpagutentetiposervizio_userCode}|${funzpagutentetiposervizio_codiceTipologiaServizio}|${funzpagutentetiposervizio_tipoboll}">
									<s:ddloption value="{1}|{2}|{3}|{17}" text="{14} / {15} / {16}"/>
								</s:dropdownlist>
							</c:when>
							<c:otherwise>
								<input type="hidden" name="codop" value="${typeRequest.addScope}" /> 
								<s:div name="strUtentetiposervizios_var">
									<s:dropdownlist name="funzpagutentetiposervizio_strUtentetiposervizios"  
										label="Societ&agrave;/Utente/Servizio:"
										cssclasslabel="label150 bold textright floatleft"
										...
										valueselected="${funzpagutentetiposervizio_strUtentetiposervizios}">
	...
	<s:div name="divRicercaTopName" cssclass="divRicercaTop">
	<s:div name="divRicercaTitleName2" cssclass="divRicTitle">Funzione Pagamento Utente - Tipologia Servizio</s:div>	
			...
			<s:table border="0" cssclass="container_btn">
				...
				<s:tbody>
					<s:tr>
						...
						<s:form name="indietro" action="funzpagutentetiposervizio.do?action=search"
						...
						<s:td>
							...
							<s:form name="form_Cancella"
										action="funzpagutentetiposervizio.do?action=cancel&funzpagutentetiposervizio_companyCode=${funzpagutentetiposervizio_companyCode}&funzpagutentetiposervizio_userCode=${funzpagutentetiposervizio_userCode}&funzpagutentetiposervizio_codiceTipologiaServizio=${funzpagutentetiposervizio_codiceTipologiaServizio}&funzpagutentetiposervizio_nomeForm=${funzpagutentetiposervizio_nomeForm}"
										method="post" hasbtn1="false" hasbtn2="false" hasbtn3="false">
	...
	<s:form name="frmConfirm" hasbtn3="false" hasbtn2="false"
			hasbtn1="false" btn1text="..." btn1onclick="this.form.submit();"
			method="post" action="funzpagutentetiposervizio.do?action=search">
