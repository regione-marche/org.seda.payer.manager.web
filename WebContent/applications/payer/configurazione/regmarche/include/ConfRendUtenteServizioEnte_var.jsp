	...
	<s:form name="var_form" action="${do_command_name}" method="post"
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<!-- REE_DREEPZIP PASSWORD ZIP -->
					<s:div name="divElement163" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="passwordZip"
							label="Password&nbsp;ZIP:" maxlenght="32" 
							cssclasslabel="label85 bold textright"
							cssclass="textareaman" validator="ignore;minlength=3;maxlength=32"
							text="${passwordZip}"  />
					</s:div>
