						...
						<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
							...
							<c:if test="${fn:substring(configutentetiposervizio_tipoBoll,0,4) == 'SPOM'}">
								...
								<s:textbox bmodify="true"
									...
									name="configutentetiposervizio_codiceContabilita"
									text="${requestScope.configutentetiposervizio_codiceContabilita}"
									cssclasslabel="label85 bold textright"
									cssclass="textareaman"  />
								</s:div>
							</c:if>
						...
						<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">
							...
							<c:if test="${fn:substring(configutentetiposervizio_tipoBoll,0,4) == 'SPOM'}">
								...
								<s:textbox bmodify="true"
									maxlenght="256"
									label="Capitolo:"
									name="configutentetiposervizio_capitolo"
									text="${requestScope.configutentetiposervizio_capitolo}"
									cssclasslabel="label85 bold textright"
									cssclass="textareaman"  />
								</s:div>
							</c:if>
						...
						<s:div name="divRicercaRight" cssclass="divRicMetadatiRight">
							...
							<c:if test="${fn:substring(configutentetiposervizio_tipoBoll,0,4) == 'SPOM'}">
								...
								<s:textbox bmodify="true"
									maxlenght="256"
									label="Articolo:"
									name="configutentetiposervizio_articolo"
									text="${requestScope.configutentetiposervizio_articolo}"
									cssclasslabel="label85 bold textright"
									cssclass="textareaman"  />
								</s:div>
								<s:div name="divElement937" cssclass="divRicMetadatiSingleRow">
									<s:textbox bmodify="true"
										...
										name="configutentetiposervizio_annoCompetenza"
										text="${requestScope.configutentetiposervizio_annoCompetenza}"
										cssclasslabel="label85 bold textright"
										cssclass="textareaman"  />
								</s:div>
							</c:if>
