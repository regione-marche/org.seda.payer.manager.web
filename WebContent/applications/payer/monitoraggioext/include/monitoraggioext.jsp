...
<s:div name="div_selezione" cssclass="div_align_center divSelezione">
	<s:div name="divRicercaTopName" cssclass="divRicercaTop">
		<s:form name="monitoraggioExtForm" action="monitoraggioext.do" method="post" 
...
<c:if test="${!empty listaMIP}">
	...
	<s:div name="divRisultati" cssclass="divRisultati">
		<s:datagrid cachedrowset="listaMIP"
			action="monitoraggioext.do?vista=monitoraggioext" border="1" usexml="true" rowperpage="${applicationScope.rowsPerPage}" viewstate="">
			...
			<s:dgcolumn index="7" label="Numero Operazione" asc="OPEA" desc="OPED" />
			<s:dgcolumn index="14" label="Numero Documento" asc="DOCA" desc="DOCD" />
			...
			<s:dgcolumn label="PaymentRequest">
				<s:hyperlink
					href="downloadXml.do?idtrans={1}&source=MIP&type=paymentrequest&form=monitoraggioExtForm"
			...
			<s:dgcolumn label="PaymentData">
				<s:hyperlink
					href="downloadXml.do?idtrans={1}&source=MIP&type=paymentdata&form=monitoraggioExtForm"
					cssclass="blacklink hlStyle"
					text="{20}"
					alt="Download PaymentData" />
			</s:dgcolumn>
			<s:dgcolumn index="11" label="Esito Notifica" asc="ESIA" desc="ESID" />
						
			<s:dgcolumn label="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Azioni&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
				<s:if left="{18}" control="eq" right="O">
				<s:then>
					<s:hyperlink
						href="notifica.do?idtrans={1}&numop={7}&idportale={5}&action=ricerca&form=monitoraggioExtForm&vista=monitoraggioext"
						cssclass="hlStyle" 
						imagesrc="../applications/templates/monitoraggioext/img/notifica.png" text="" 
						alt="Rinotifica" />
					<s:hyperlink
						href="dettaglioNotifica.do?chiave_transazione_hidden={1}"
						cssclass="hlStyle" 
						imagesrc="../applications/templates/monitoraggioext/img/details.png" text="" 
						alt="Dettaglio" />
				</s:then>
				<s:else>
					<s:hyperlink
