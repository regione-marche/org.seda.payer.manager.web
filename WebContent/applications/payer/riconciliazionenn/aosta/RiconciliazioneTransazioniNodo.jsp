...
<!-- lep utente eliminato -->
		...
		<s:dgcolumn index="1" label="Id. Quadratura" asc="KEYA" desc="KEYD" css="text_align_right"></s:dgcolumn>
			...
			<s:thendatagrid>
				...
				<%-- fine LP PG200200 --%>
				<!-- YLM PG22XX05_26 -->
				<%-- <s:dgcolumn index="38" label="Errore" css="text_align_right"></s:dgcolumn> --%>
			</s:thendatagrid>
		</s:ifdatagrid>
		<s:dgcolumn label="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Azioni&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
			...
			<s:if right="{35}" control="eq" left="Y">
				<s:then>
					<s:hyperlink href="dettaglioIUVFlusso.do${formParameters}&idflusso={17}&societa={3}&data={18}&numrt={27}&iuvsca={10}&idquad={1}&flusso_errore={38}&tx_button_cerca=1"
			...
			<s:if right="{31}" control="eq" left="1">
				<s:then>
					<s:hyperlink href="reinvioFlussoQuadraturaNodo.do?FileNameFlusso={6}&idDominio={25}&cutecute={4}&idFlusso={17}&keyQuadratura={1}&keyEnte={32}&codSoc={3}"
			...
			<s:if right="{31}" control="eq" left="2">
				<s:then>
