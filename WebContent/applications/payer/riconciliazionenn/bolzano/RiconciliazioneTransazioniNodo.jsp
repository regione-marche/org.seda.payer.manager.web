...
<c:url value="" var="formParameters">
	...
	<c:if test="${!empty param.esitoInvioConservazione}">
		<c:param name="esitoInvioConservazione">${param.esitoInvioConservazione}</c:param>
	</c:if>
...
<%--
				...
				<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">
					...
					<s:div name="divElement14e" cssclass="divRicMetadatiSingleRow">
						<s:dropdownlist name="esitoInvioConservazione" cssclass="tbddl floatleft"
							cssclasslabel="label85 bold floatleft textright" disable="false"
							label="Esito Invio Conservazione:" valueselected="${esitoInvioConservazione}">
							<s:ddloption value="" text="Tutte" />
							<s:ddloption value="OK" text="OK" />
							<s:ddloption value="KO" text="KO" />
						</s:dropdownlist>
					</s:div>
<!-- 
					<s:div name="divElement12" cssclass="divRicMetadatiDoubleRow">
...
<!-- lep utente eliminato -->
		...
		<s:dgcolumn index="37" label="Esito Invio Conservatoria" asc="ESINVA" desc="ESINVD" css="text_align_right"></s:dgcolumn>
