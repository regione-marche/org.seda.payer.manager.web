...
<!-- lep utente eliminato -->
		...
		<s:dgcolumn label="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Azioni&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
			...
			<s:if right="{35}" control="eq" left="Y">
				<s:then>
					<s:hyperlink href="dettaglioIUVFlusso.do?idflusso={17}&societa={3}&data={18}&numrt={27}&iuvsca={10}&idquad={1}&tx_button_cerca=1"
			...
			<s:if right="{36}" control="eq" left="Y">
				<s:then>
					<s:hyperlink href="ritentaQuadraturaFlusso.do?idquad={1}&vista=riconciliazionetransazioninodo&tx_button_cerca=tx_button_cerca"
