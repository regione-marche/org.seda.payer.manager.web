		...
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
					...
					<s:div name="divElement6" cssclass="divRicMetadatiRight">
						<s:textbox bmodify="true" name="tx_desc_aggiuntiva_soggetto"
								label="Descrizione Aggiuntiva: " maxlenght="128" 
								cssclasslabel="label85 bold floatleft textright"
								showrequired="false"
								cssclass="textareaman" validator="ignore;accept=${wisconfig_descrizione128_regex}"
								text="${tx_desc_aggiuntiva_soggetto}" message="[accept=Descrizione Aggiuntiva: ${msg_configurazione_descrizione_regex}]"/>	
					</s:div>
					
					<s:div name="divElement7" cssclass="divRicMetadatiLeft">
							<s:textbox bmodify="true" name="tx_prog_ordinamento"
								label="Prog. Ordinamento: " 
								cssclasslabel="label85 bold floatleft textright"
								showrequired="false"
								cssclass="textareaman" validator="ignore;digits"
								text="${tx_prog_ordinamento}" message="[accept=Prog. Ordinamento: ${msg_configurazione_numero}]"/>
					</s:div>
					
					<s:div name="divElement8" cssclass="divRicMetadatiCenter">
						
					</s:div>
					
					<s:div name="divElement9" cssclass="divRicMetadatiRight">
