...
<m:view_state id="impostaSoggiornoAnagStruttura_cancel" encodeAttributes="true" />


<s:div name="div_delete" cssclass="div_align_center divSelezione">
	<s:div name="divDeleteTopName" cssclass="divRicercaTop">
	<s:form name="delete_form" action="ImpostaSoggiornoAnagStrutturaCancel.do" method="post"
