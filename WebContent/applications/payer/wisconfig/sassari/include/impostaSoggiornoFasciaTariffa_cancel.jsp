...
<m:view_state id="impostaSoggiornoFasciaTariffa_cancel" encodeAttributes="true" />

<s:div name="div_delete" cssclass="div_align_center divSelezione">
	<s:div name="divDeleteTopName" cssclass="divRicercaTop">
		<s:form name="delete_fascia_form" action="ImpostaSoggiornoFasciaTariffaCancel.do" method="post"
			hasbtn1="false" hasbtn2="false" hasbtn3="false">
			<s:div name="divRicercaTitleName" cssclass="divRicTitle">
			CANCELLA FASCIA TARIFFA
			</s:div>
