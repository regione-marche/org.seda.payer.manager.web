				...
				<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">
					...
					<s:div name="divElement8" cssclass="divRicMetadatiSingleRow">
						<s:dropdownlist name="provenienza" cssclass="tbddl floatleft"
							...
							<s:ddloption value="Poste" text="Poste" />
						</s:dropdownlist>
					</s:div>
...
<c:if test="${!empty lista_giornali_di_cassa}">
	...
	<s:datagrid cachedrowset="lista_giornali_di_cassa"
		...
		<s:dgcolumn index="5" label="Data Flusso" format="dd/MM/yyyy" asc="DTGA" desc="DTGD"></s:dgcolumn>
		<s:dgcolumn index="6" label="Identificativo Flusso" asc="IDFA" desc="IDFD"></s:dgcolumn>
		<s:dgcolumn index="8" label="Movimenti Regolarizzati" asc="SRNA" desc="SRND"></s:dgcolumn>
		<s:dgcolumn label="Azioni">
			<s:hyperlink
				href="dettaglioGiornaleCassa.do${formParameters}&ente={2}&prov={3}&data={5}&idflusso={6}&esercizio={4}&srego={7}&srend={8}&idgdc={1}&tx_button_cerca=cerca"
				cssclass="blacklink hlStyle"
				imagesrc="../applications/templates/shared/img/Info.png" text=""
				alt="Dettaglio Flusso" />
		</s:dgcolumn>
