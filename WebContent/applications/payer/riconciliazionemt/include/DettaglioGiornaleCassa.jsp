		...
		<s:form name="dettaglioGiornaleCassaForm"
			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
						...
						<s:table cssclass="seda-ui-datagrid" border="1" cellspacing="0" cellpadding="3">
							<s:thead>
								<s:tr cssclass="seda-ui-datagridrowdispari">
									...
									<s:th cssclass="seda-ui-datagridcell">Data Giornale</s:th>
									<s:th cssclass="seda-ui-datagridcell">Identificativo Flusso</s:th>
									<s:th cssclass="seda-ui-datagridcell">Esercizio</s:th>
									<s:th cssclass="seda-ui-datagridcell">Sospesi Regolarizzati</s:th>
									<s:th cssclass="seda-ui-datagridcell">Sospesi Rendicontati</s:th>
								</s:tr>
							</s:thead>
							<s:tbody>
				...
				<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
					...
					<s:div name="divElement8" cssclass="divRicMetadatiSingleRow">
						<s:dropdownlist name="statoSospeso" cssclass="tbddl floatleft"
							cssclasslabel="label85 bold floatleft textright" disable="false"
							label="Stato Sospeso:" valueselected="${statoSospeso}">
							<s:ddloption value="" text="Tutti gli stati" />
							<s:ddloption value="ESEGUITO" text="ESEGUITO" />
							<s:ddloption value="REGOLARIZZATO" text="REGOLARIZZATO" />
						</s:dropdownlist>
					</s:div>
				...
				<s:div name="divRicercaRight" cssclass="divRicMetadatiRight">
					...
					<s:div name="divElement8" cssclass="divRicMetadatiSingleRow">
						<s:dropdownlist name="conto" cssclass="tbddl floatleft"
							cssclasslabel="label85 bold floatleft textright" disable="false"
							label="Conto:" valueselected="${conto}"
							cachedrowset="lista_conto" usexml="true">
							<s:ddloption value="" text="Tutti i conti" />
...
<c:if test="${!empty lista_movimenti_di_cassa}">
	...
	<s:datagrid cachedrowset="lista_movimenti_di_cassa"
		...
		<s:dgcolumn index="8" label="Rendicontato" asc="RENA" desc="REND"></s:dgcolumn>
		<s:dgcolumn index="9" label="Regolarizzato" asc="REGA" desc="REGD"></s:dgcolumn>
		<s:dgcolumn index="10" label="Data Regolarizzazione" format="dd/MM/yyyy" asc="DTRA" desc="DTRD"></s:dgcolumn>
			...
			<s:if right="{11}" control="ne" left="">
				<s:then>
					<s:hyperlink
						...
						alt="Errore in fase di abbinamento del sospeso"
