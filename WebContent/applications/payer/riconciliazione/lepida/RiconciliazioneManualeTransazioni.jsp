...
<c:url value="" var="formParameters">
	...
	<c:if test="${!empty param.data_pagamento_da_day}">
		<c:param name="data_pagamento_da_day">${param.data_pagamento_da_day}</c:param>
	</c:if>
	<c:if test="${!empty param.data_pagamento_da_month}">
		<c:param name="data_pagamento_da_month">${param.data_pagamento_da_month}</c:param>
	</c:if>
	<c:if test="${!empty param.data_pagamento_da_year}">
		<c:param name="data_pagamento_da_year">${param.data_pagamento_da_year}</c:param>
	</c:if>
	<c:if test="${!empty param.data_pagamento_a_day}">
		<c:param name="data_pagamento_a_day">${data_pagamento_a_day}</c:param>
	</c:if>
	<c:if test="${!empty param.data_pagamento_a_month}">
		<c:param name="data_pagamento_a_month">${param.data_pagamento_a_month}</c:param>
	</c:if>
	<c:if test="${!empty param.data_pagamento_a_year}">
		<c:param name="data_pagamento_a_year">${param.data_pagamento_a_year}</c:param>
	</c:if>
...
<!-- lep cro -->										
	...
	<s:div name="divRicercaMovimento" cssclass="divRicMetadatiSingleRow">
		...
		<s:dropdownlist name="chiaveMovimento" disable="false"
			...
			<s:ddloption text="Id. Quad. {1} - {2} - {3} - {4} - {5} - {6} - {7}" value="{1}" />
		</s:dropdownlist>
		<noscript>
