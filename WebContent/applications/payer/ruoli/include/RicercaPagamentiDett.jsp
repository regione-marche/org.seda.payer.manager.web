...
<c:if test="${!empty listaPagamenti}">
	...
	<s:datagrid  viewstate="" cachedrowset="listaPagamenti" action="ricercaPagamentiDett.do" border="1" usexml="true"  rowperpage="${applicationScope.rowsPerPage}">
		<s:action>
			<c:url value="ricercaPagamentiDett.do" >
	...
	<s:div name="indietro" cssclass="divRicBottoni">
		<s:form name="ricercaPagamentiDett" action="ricercaPagamentiDett.do" method="post" hasbtn1="false" hasbtn2="false" hasbtn3="false">
