...
<s:div name="div_selezione" cssclass="div_align_center divSelezione">
	<s:div name="divRicercaTopName" cssclass="divRicercaTop">
		...
		<s:form name="ricercaRuoliForm" action="ricercaRuoli.do" method="post" hasbtn1="false" hasbtn2="false" hasbtn3="false">
...
<c:if test="${!empty listaRuoli}">
	...
	<s:div name="divRisultati" cssclass="divRisultati">
		...
		<s:datagrid  viewstate="" cachedrowset="listaRuoli" action="ricercaRuoli.do" border="1" usexml="true"  rowperpage="${applicationScope.rowsPerPage}">
			<s:action>
				<c:url value="ricercaRuoli.do" >
			<c:if test="${!empty tx_societa}">  
				<c:param name="tx_societa">${tx_societa}</c:param>
			</c:if>
			<c:if test="${!empty tx_utente}">  
			...
			<!-- RRU_GRRUGRUO -->
			<s:dgcolumn index="14"  format="dd/MM/yyyy" label="Data Consegna" asc="DTCA" desc="DTCD"></s:dgcolumn>
			...
			<!-- CARICO -->
			<s:dgcolumn index="8" format="#,##0.00" label="Carico" asc="CARA" desc="CARD" css="text_align_right"></s:dgcolumn>
	
			<!-- DIM. CARICO -->
			<s:dgcolumn index="9" format="#,##0.00" label="Dim.Carico" asc="DCAA" desc="DCAD" css="text_align_right"></s:dgcolumn>
	
			<!-- RISCOSSO -->
			<s:dgcolumn index="10" format="#,##0.00" label="Riscosso" asc="RSCA" desc="RSCD" css="text_align_right"></s:dgcolumn>
	        
			<!-- RIMBORSO -->
			<s:dgcolumn index="11" format="#,##0.00" label="Rimborso" asc="RIMA" desc="RIMD" css="text_align_right"></s:dgcolumn>
	        
			<!-- RESIDUO asc="RSDA" desc="RSDD"-->
			<s:dgcolumn index="12" format="#,##0.00" label="Residuo" asc="RSDA" desc="RSDD" css="text_align_right"></s:dgcolumn>
		    ...
		    <s:dgcolumn label="Dett." >
				&nbsp;
				<s:hyperlink href="dettaglioRuolo.do${formParameters}&tx_button_cerca=OK&chiaveCodSoc={1}&chiaveCodUte={2}&chiaveCodEnte={18}&chiaveAnnoRuo={4}&chiaveNumRuo={5}&chiaveFlusso={15}&chiaveConc={16}&chiaveTomb={17}&rRowsPerPage=${param.rowsPerPage}&rPageNumber=${param.pageNumber}&rOrder=${param.order}" 
				alt="Dettaglio Ruolo" 
		    ...
		    <s:dgcolumn label="Part." >
				{13}&nbsp;
				<s:hyperlink href="ricercaPartiteRuoli.do${formParameters}&tx_button_cerca=OK&chiaveCodSoc={1}&chiaveCodUte={2}&chiaveCodEnte={18}&chiaveAnnoRuo={4}&chiaveNumRuo={5}&chiaveFlusso={15}&chiaveConc={16}&chiaveTomb={17}&rRowsPerPage=${param.rowsPerPage}&rPageNumber=${param.pageNumber}&rOrder=${param.order}" 
				alt="Lista Partite" 
		...
		<s:table  border="1" cellspacing="0" cellpadding="3"  cssclass="seda-ui-datagrid">
			<s:thead>
				<s:tr cssclass="seda-ui-datagridrowpari">
					<s:th cssclass="seda-ui-datagridheadercell"  icol="8"><b>Totali Ruoli</b></s:th>
				</s:tr>
			</s:thead>
			<s:tbody>
				<s:tr cssclass="seda-ui-datagridrowpari">
