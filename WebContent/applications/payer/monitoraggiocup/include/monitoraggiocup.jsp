...
<m:view_state id="monitoraggiocup" encodeAttributes="true" />
...
<s:div name="div_selezione" cssclass="div_align_center divSelezione">
	<s:div name="divRicercaTopName" cssclass="divRicercaTop">
		<s:form name="monitoraggioExtForm" action="monitoraggiocup.do" method="post" 
				...
				<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
					...
					<s:div name="divElement5" cssclass="divRicMetadatiSingleRow">
						<s:textbox validator="maxlength=128" bmodify="true"
							...
							cssclass="textareaman"
							cssclasslabel="label85 bold textright"
							name="txtNumeroOperazione" label="N.Operazione:"
							text="${txtNumeroOperazione}" />
					</s:div>
				...
				<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">
					...
					<s:div name="divElement6" cssclass="divRicMetadatiSingleRow">
						<s:dropdownlist name="ddlEsitoNotifica" disable="false"
							...
							<s:ddloption value=" " text="Senza Esito" />
							<s:ddloption value="OK" text="Esito Positivo" />
							<s:ddloption value="NOK" text="Esito Negativo" />
						</s:dropdownlist>
					</s:div>
					...
					<s:div name="divElement7" cssclass="divRicMetadatiSingleRow">
						<s:textbox validator="maxlength=128" bmodify="true"
							...
							cssclass="textareaman"
							cssclasslabel="label85 bold textright"
							name="txtCodicePagamento" label="Cod.Pagamento:"
							text="${txtCodicePagamento}" />
					</s:div>
				</s:div>
...
<c:if test="${!empty listaMIC}">
	...
	<s:div name="divRisultati" cssclass="divRisultati">
		<s:datagrid cachedrowset="listaMIC"
			action="monitoraggiocup.do?vista=monitoraggiocup" border="1" usexml="true" rowperpage="${applicationScope.rowsPerPage}" viewstate="">
			
			<s:dgcolumn index="17" label="Ente" asc="ENTA" desc="ENTD" />
			...
			<s:dgcolumn index="8" label="Numero Operazione" asc="OPEA" desc="OPED" />
			<s:dgcolumn index="15" label="Numero Documento" asc="DOCA" desc="DOCD" />
			<s:dgcolumn index="16" label="Data/Ora Aggiornamento" asc="AGGA" desc="AGGD" format="dd/MM/yyyy HH:mm:ss"/>
			<s:dgcolumn label="PaymentRequest">
				<s:hyperlink
					href="downloadXml.do?idtrans={1}&codiceFiscale={2}&codicePagamento={3}&source=MIC&type=paymentrequest&form=monitoraggioExtForm"
			...
			<s:dgcolumn label="PaymentData">
				<s:hyperlink
					href="downloadXml.do?idtrans={1}&codiceFiscale={2}&codicePagamento={3}&source=MIC&type=paymentdata&form=monitoraggioExtForm"
					cssclass="blacklink hlStyle"
					text="{20}"
					alt="Download PaymentData" />
			</s:dgcolumn>
			<s:dgcolumn index="12" label="Esito Notifica" asc="ESIA" desc="ESID" />
						
			<s:dgcolumn label="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Azioni&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
				<s:hyperlink
					href="notifica.do?idtrans={1}&codiceFiscale={2}&codicePagamento={3}&numop={8}&idportale={7}&action=ricerca&form=monitoraggioExtForm&vista=monitoraggiocup"
					cssclass="hlStyle" 
					imagesrc="../applications/templates/monitoraggiocup/img/notifica.png" text="" 
					alt="Rinotifica" />
				<s:hyperlink
					href="dettaglioNotifica.do?chiave_transazione_hidden={1}&codiceFiscale_hidden={2}&codicePagamento_hidden={3}"
					cssclass="hlStyle" 
					imagesrc="../applications/templates/monitoraggiocup/img/details.png" text="" 
					alt="Dettaglio" />
			</s:dgcolumn>
		</s:datagrid>
	</s:div>
