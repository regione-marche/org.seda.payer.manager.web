		...
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			...
			<s:div name="divRicMetadatiTop" cssclass="divRicMetadatiTop">
				...
				<s:div name="divRicercaRight" cssclass="divRicMetadatiRight">
					<s:div name="divElement8" cssclass="divRicMetadatiSingleRow">
						<s:dropdownlist name="tx_anagraficaattiva" disable="false"
							cssclass="tbddlMax floatleft" label="Stato Anagrafica:"
							cssclasslabel="label85 bold textright"
							valueselected="${tx_anagraficaattiva}">
							<s:ddloption text="Tutte le Anagrafiche" value="" />
							<s:ddloption text="Anagrafiche Attive" value="N" />
							<s:ddloption text="Anagrafiche non Attive" value="Y" />
						</s:dropdownlist>
				...
				<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">		
					<s:div name="divElement8" cssclass="divRicMetadatiSingleRow">
						<s:dropdownlist name="tx_mail" disable="false"
							cssclass="tbddlMax floatleft" label="Attivazione MAIL:"
							cssclasslabel="label85 bold textright"
							valueselected="${tx_mail}">
				...
				<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">
					<s:div name="divElement8" cssclass="divRicMetadatiSingleRow">
						<s:dropdownlist name="tx_sms" disable="false"
							cssclass="tbddlMax floatleft" label="Attivazione SMS:"
							cssclasslabel="label85 bold textright"
							valueselected="${tx_sms}">
							<s:ddloption text="Tutte..." value="" />
							<s:ddloption text="NO" value="N" />
							<s:ddloption text="SI" value="Y" />
						</s:dropdownlist>
	...
	<s:div name="div_datagrid">
		<s:datagrid viewstate="" cachedrowset="lista_anaboll"
			...
			<s:dgcolumn label="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" css="nowrap">
				...
				<!-- PG170280 CT -->
				<s:hyperlink
					href="ecanagrafica.do?tx_genera_lettera=true&codfisc={4}&ddlSocietaUtenteEnte={1}|{2}|{3}"					
					imagesrc="../applications/templates/shared/img/pdf.png"
					alt="Genera Lettera di benvenuto" text=""
					cssclass="blacklink hlStyle" />
				
				<s:if left="{11}" control="eq" right="N">
					<s:then>
						<s:hyperlink
						href=""					
						imagesrc="../applications/templates/shared/img/Info.png"
						alt="Codice di Attivazione scaduto o già utilizzato" text=""
						cssclass="blacklink hlStyle" />				
					</s:then>
				</s:if>

				<s:if left="{12}" control="eq" right="Y" operator="and" secondleft="{8}{9}" secondcontrol="ne" secondright="">
					<s:then><s:hyperlink
							href="ecanagrafica.do?tx_genera_lettera=true&tx_invia_lettera=true&codfisc={4}&ddlSocietaUtenteEnte={1}|{2}|{3}"					
							imagesrc="../applications/templates/shared/img/sendmail.gif"
							alt="Invia Lettera di benvenuto" text=""
							cssclass="blacklink hlStyle" />
				</s:then>
				</s:if>
