		...
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
					...
					<s:div name="divElement4a" cssclass="divRicMetadatiSingleRow">
						<s:dropdownlist name="tx_TipoGateways"
							disable="false" cssclass="tbddlMax floatleft"
							label="Gateway:" cssclasslabel="label85 bold textright"
							valueselected="${tx_TipoGateways}">
							<s:ddloption text="Tutti" value="" />
							<s:ddloption text="Nodo Nazionale" value="N"/> 
							<s:ddloption text="MyPay" value="A"/>
						</s:dropdownlist>					
					</s:div>
...
<c:if test="${!empty listaMIP}">
	...
	<s:div name="divRisultati" cssclass="divRisultati">
		<s:datagrid cachedrowset="listaMIP"
			...
			<s:dgcolumn label="Gateway" asc="GTWA" desc="GTWD">
				<s:if left="{21}" control="eq" right="">
					<s:then>Non definito
					</s:then>
				</s:if>
				...
				<s:if left="{21}" control="eq" right="N">
					<s:then>Nodo Nazionale
					</s:then>
				</s:if>
			</s:dgcolumn>
