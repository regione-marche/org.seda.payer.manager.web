		...
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
					...
					<br /><br />
					<s:dropdownlist name="tx_esitoinvio"
							disable="false" cssclass="tbddl floatleft"
							label="Esito Invio Conservazione:"
							cssclasslabel="label85 bold floatleft textright"
							valueselected="${tx_esitoinvio}">
							<s:ddloption text="Tutti gli esiti" value="" />
...
<c:if test="${!empty listaMIP}">
	...
	<s:div name="divRisultati" cssclass="divRisultati">
		<s:datagrid cachedrowset="listaMIP"
			...
			<!-- AGGIUNGERE INDEX E ASC/DESC -->
			<s:dgcolumn index="22" label="Esito Invio Conservazione" asc="ESINVA" desc="ESINVD" />			
