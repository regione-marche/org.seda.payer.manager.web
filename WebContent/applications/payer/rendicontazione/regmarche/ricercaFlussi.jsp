		...
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			...
			<s:div name="divRicercaBottoni" cssclass="divRicBottoni">
				...
				<c:if test="${!empty lista_flussi}">
					...
					<s:button id="tx_button_stampa" onclick="" text="Stampa" cssclass="btnStyle" type="submit" />
				</c:if>
			</s:div>
	</s:form>
