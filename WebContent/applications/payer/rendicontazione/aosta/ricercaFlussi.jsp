			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
					...
					<s:div name="divElement14" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="giornaleCassa"
							label="Giornale Di Cassa:" maxlenght="256" 
							cssclasslabel="label85 bold textright"
							cssclass="textareaman" validator="ignore;accept=^[0-9a-zA-Z\-#]{1,256}$"
							message="[accept=Giornale di Cassa: ${msg_configurazione_descrizione_5}]"
							text="${giornaleCassa}" />
					</s:div>
				</s:div>
				<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">
					...
					<s:div name="divElement101" cssclass="divRicMetadatiSingleRow">
						<s:textbox validator="ignore;numberIT" maxlenght=""
							cssclass="textareaman" cssclasslabel="label85 bold textright"
							bmodify="true" name="movimentoCassa" label="Movimento di Cassa:"
							text="${movimentoCassa}" />
					<input type="hidden" id="idMovimentoCassa" name="idMovimentoCassa" value="${idMovimentoCassa}" />
					</s:div>
				</s:div>
		...
		<s:datagrid viewstate="" cachedrowset="lista_flussi"
			...
			<s:dgcolumn label="Chiave&nbsp;Flusso" asc="KREN_A" desc="KREN_D">
			    <c:if test="${appMonitoraggioUteEnabled}">
					<s:hyperlink href="../monitoraggio/monitoraggioTransazioni.do?tx_chiave_rendicontazione={8}&tx_button_cerca=cerca&idmdc=${idMovimentoCassa}" 
			...
			<s:dgcolumn label="Azioni">
				<s:if right="{17}" control="eq" left="Y" operator="and" 
							secondright="${idMovimentoCassa}" secondcontrol="ne" secondleft="" >
					<s:then>
						<s:hyperlink href="../riconciliazionemt/dettaglioMovimentoCassa.do?idmdc=${idMovimentoCassa}"
							imagesrc="../applications/templates/riconciliazionenn/img/key.png" 
							alt="Dettaglio Movimento di Cassa" text="" cssclass="hlStyle" />
					</s:then>
					<s:else>
					</s:else>
				</s:if>
