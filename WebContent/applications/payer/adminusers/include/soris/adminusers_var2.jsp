			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
					...
					<s:div name="divElement94" cssclass="divRicMetadatiSingleRow">
						<s:list bradio="false" bchecked="${chk_ecnotifiche}" validator="ignore" 
						 cssclasslabel="bold checklabel label220" cssclass="checkleft"   disable="${ecnotificheDisabled}" 
						name="ecnotifiche" groupname="ecnotifiche" 
						text="Estratto Conto Notifiche" value="Y" />
					</s:div>
					<!-- PG180300 20190325 CT -->
					<s:div name="divElement194" cssclass="divRicMetadatiSingleRow">
						<s:list bradio="false" bchecked="${chk_ecagemanager}" validator="ignore" 
						 cssclasslabel="bold checklabel label220" cssclass="checkleft"   disable="${ecmanagerDisabled}" 
						name="ecagemanager" groupname="ecagemanager" 
						text="Estratto Conto Agenzie" value="Y" />
					</s:div>
					<!-- FINE PG180300 20190325 CT -->
...
<!-- fine dom -->
				...
				<s:div name="divRicercaRight" cssclass="divRicMetadatiRight">
					...
					<!-- PG180040 Nuova Sezione Mercato -->
					<s:div name="divElementMERCATOCONFIG" cssclass="divRicMetadatiSingleRow">
						<s:list bradio="false" bchecked="${chk_mercatoconfig}" validator="ignore" 
						 cssclasslabel="bold checklabel label220" cssclass="checkleft" disable="${mercatoconfigDisabled}" 
						name="mercatoconfig" groupname="mercatoconfig" 
						text="Configurazione Mercato" value="Y" />
					</s:div>  
					<s:div name="divElementMERCATIMANAGER" cssclass="divRicMetadatiSingleRow">
						<s:list bradio="false" bchecked="${chk_mercatimanager}" validator="ignore" 
						 cssclasslabel="bold checklabel label220" cssclass="checkleft"   disable="${mercatimanagerDisabled}" 
						name="mercatimanager" groupname="mercatimanager" 
						text="Mercati Manager" value="Y" />
					</s:div>
					<s:div name="divElementMONITORAGGIOMERCATI" cssclass="divRicMetadatiSingleRow">
						<s:list bradio="false" bchecked="${chk_monitoraggiomercati}" validator="ignore" 
						 cssclasslabel="bold checklabel label220" cssclass="checkleft"   disable="${monitoraggiomercatiDisabled}" 
						name="monitoraggiomercati" groupname="monitoraggiomercati" 
						text="Monitoraggio Mercati" value="Y" />
					</s:div>
					
					<!-- Fine Nuova Sezione Mercato -->
