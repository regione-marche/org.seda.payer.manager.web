		...
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
					...
					<s:div name="divElement193" cssclass="divRicMetadatiSingleRow">
						<s:list bradio="false" bchecked="${chk_eccedenze}" validator="ignore" 
						 cssclasslabel="bold checklabel label220" cssclass="checkleft"   disable="${eccedenzeDisabled}" 
						name="eccedenze" groupname="eccedenze" 
						text="Manager Eccedenze" value="Y" />
					</s:div>
...
<!-- dom -->
					<s:div name="divElement99" cssclass="divRicMetadatiSingleRow">
						<s:list bradio="false" bchecked="${chk_contogestione}" validator="ignore" 
						 cssclasslabel="bold checklabel label220" cssclass="checkleft" onclick="toggleContogestione()"
						name="contogestione" groupname="contogestione" disable="${contogestioneDisabled}"   
						text="Conto Gestione" value="Y" />
					</s:div>
...
<!-- fine dom -->
				...
				<s:div name="divRicercaRight" cssclass="divRicMetadatiRight">
					...
					<s:div name="divElement97" cssclass="divRicMetadatiSingleRow">
						<s:list bradio="false" bchecked="${chk_riversamento}" validator="ignore" 
						 cssclasslabel="bold checklabel label220" cssclass="checkleft" onclick="toggleRiversamento()"
						name="riversamento" groupname="riversamento" disable="${riversamentoDisabled}"   
						text="Riversamento" value="Y" />
					</s:div>
