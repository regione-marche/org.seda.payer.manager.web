	...
	<s:form name="var_form" action="${do_command_name}" method="post"
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<!-- USERID -->
					...
					<s:div name="divElement4" cssclass="divRicMetadatiSingleRow">
						...
						<s:textbox readonly="true" bmodify="false" name="tx_username" 
							label="(*)&nbsp;UserId:" 
			...
			<s:div name="divOpeBackOffice" cssclass="divRicMetadatiSingleRow">
				...
				<c:if test="${codop == 'edit'}">
					<s:list bradio="false" bchecked="${requestScope.reg_profilo.flagNoControlli}" validator="ignore" 
						cssclasslabel="bold checklabel label150" cssclass="checkleft"
						name="flagNoControlli" groupname="flagNoControlli" 
						text="Non eseguire controlli" value="Y" />
				</c:if>	
			</s:div>
