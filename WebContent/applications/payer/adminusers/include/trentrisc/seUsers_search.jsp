			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<s:div name="divRicercaRight" cssclass="divRicMetadatiRight">
					...
					<s:div name="divElement94" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="tx_cfPIva"
							label="CF./P.IVA:" maxlenght="256" 
							cssclasslabel="label85 bold textright"
							cssclass="textareaman" 
							text="${tx_cfPIva}" />
					</s:div>
...
<c:if test="${!empty listaUsers}">
	...
	<s:div name="div_datagrid">
	    ...
	    <%-- ABILITA DIABILITA UTENTE PG150420 --%>
	  
				<s:hyperlink
					cssclass="hlStyle" 
					href="seUsersEnable.do?tx_username_hidden={5}"
					imagesrc="../applications/templates/adminusers/img/circle_{4}.png"
					alt="Abilita o disabilita User {5}" text="" />
