			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<!-- Il codice fiscale viene visualizzato con la label "UserId"  -->
					...
					<s:div name="divElement4" cssclass="divRicMetadatiSingleRow">
						...
						<c:if test="${codop == 'edit'}">
							<s:textbox bmodify="${codiceFiscaleModificabile}" name="tx_username"
								label="UserId(CF):" maxlenght="16" showrequired="false" 
								cssclasslabel="label65 bold textright"
								cssclass="textareaman border_none" validator="ignore"
								message="[accept=UserId (CF): ${msg_configurazione_codicefiscale_piva}]"
								text="${tx_username}" />
						</c:if>
