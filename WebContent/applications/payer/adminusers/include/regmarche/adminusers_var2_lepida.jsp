		...
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
					...
					<s:div name="divElement293" cssclass="divRicMetadatiSingleRow">
						<s:list bradio="false" bchecked="${chk_monitoraggiocup}" validator="ignore" 
						 cssclasslabel="bold checklabel label220" cssclass="checkleft"   disable="${monitoraggiocupDisabled}" 
						name="monitoraggiocup" groupname="monitoraggiocup" 
						text="Monitoraggio Notifiche Cup" value="Y" />
					</s:div>
				...
				<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">
					...
					<s:div name="divElement293" cssclass="divRicMetadatiSingleRow">
						<s:list bradio="false" bchecked="${chk_monitoraggiocruss}" validator="ignore" 
						 cssclasslabel="bold checklabel label220" cssclass="checkleft"   disable="${monitoraggiocrussDisabled}" 
						name="monitoraggiocruss" groupname="monitoraggiocruss" 
						text="Monitoraggio Cruscotto" value="Y" />
					</s:div>
