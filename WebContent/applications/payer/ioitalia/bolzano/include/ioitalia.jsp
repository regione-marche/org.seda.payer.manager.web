			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
					<s:div name="divElement4" cssclass="divRicMetadatiSingleRow">
						<s:dropdownlist name="tx_tipServ" disable="false"
							cssclass="tbddl" label="Tipologia Servizio AppIO:"
				...
				<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">
					...
					<s:div name="divElement9" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="tx_codiceFiscale_s"
							label="Codice Fiscale:"
							cssclasslabel="label85 bold textright"
							cssclass="textareaman"
							text="${tx_codiceFiscale_s}" />
					</s:div>
				</s:div>
...
<c:if test="${!empty lista_forniture}">
	...
	<s:div name="div_datagrid">
		<s:datagrid viewstate="" cachedrowset="lista_forniture"
			...
			<s:dgcolumn index="9" label="Tipologia Servizio AppIO" asc="TIP_A" desc="TIP_D"></s:dgcolumn>
