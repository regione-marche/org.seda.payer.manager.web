	...
	<s:div name="divRicercaTopName" cssclass="divRicercaTop">
		<s:form name="var_form" action="ioitaliaconfedit.do?vista=${vista}"
			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
						...
						<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
							<s:div name="divElement1" cssclass="divRicMetadatiSingleRow">
								<s:dropdownlist name="tx_tipServ" showrequired="true"
									label="Tipologia Servizio:" disable="${codop == 'edit'}"
									onchange="setFired();this.form.submit();" cachedrowset="listaTipologieServizio" usexml="true" 
									cssclasslabel="label160 bold floatleft"
									validator="required;" cssclass="textareaman"
				...
				<c:if test="${codop == 'edit'}">
					...
					<s:div name="divElement5top" cssclass="divRicMetadatiCenter">
						...
						<s:div name="divElement2" cssclass="divRicMetadatiSingleRow">
							<s:textbox bmodify="false" name="tx_impServ_s"
										bdisable="true" validator="required;" showrequired="true"
										label="Imposta Servizio:"
										cssclasslabel="label85 bold textright floatleft" cssclass="textareaman"
										text="${tx_desc_impServ_s}" />
						</s:div>
						<br /><br />
					</s:div>
			...
			<br />
					...
					<!-- s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft"-->
						...
						<s:textbox bmodify="true" name="tx_firstKey_s"
							label="Chiave Primaria:" maxlenght="35" validator="required;" showrequired="true"
			...
			<br />
					...
					<!--  s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft" -->
						<s:textbox bmodify="true" name="tx_firstKey2_s" validator="required;" showrequired="true"
					...
					<s:div name="divRicercaRight" cssclass="divRicMetadatiRight">
						<s:div name="divElement4" cssclass="divRicMetadatiSingleRow">
							<s:textbox bmodify="true" name="tx_mail_s"
									label="Mail statistiche elaborazioni:" validator="required;" showrequired="true"
