...
<script type="text/javascript">
	...
	function ControllaSalva(){
		...
		var codiceServizio = document.getElementById('tx_codiceServizio').value;
		...
		//inizio LP PG210070 - 20210729
			if((codiceServizio != null) && (codiceServizio != "")) {
				if(isNaN(codiceServizio)) {
					writeMsg("Codice Servizio: inserisci valori numerici");
					return false;
				}
				if(codiceServizio.length < 2) {
					writeMsg("Codice Servizio: il campo deve essere lungo 2");
					return false;
				}
			}
		} else {
			...
			if((codiceServizio != null) && (codiceServizio != "")) {
				writeMsg("Se Aux Digit non è valorizzato a 3 il Codice Servizio non deve essere valorizzato");
				return false;
			}
		//fine LP PG210070 - 20210729
		}
		...
		<div class="seda-ui-divvalidator"><span id="wrtMsg_message"class="seda-ui-spanvalidator"><br></span></div>
			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<s:div name="divRicercaRight2" cssclass="divRicMetadatiCenter">
					...
					<s:div name="divElement1" cssclass="divRicMetadatiSingleRow">
						<s:dropdownlist name="tx_flagPoste" showrequired="true" 
							label="Flag Poste: " disable="false"
							cssclasslabel="label85 bold textright" validator="required;"
							cssclass="textareaman" 
							valueselected="${tx_flagPoste}">
  							<s:ddloption text="Sì" value="Y" />
  							<s:ddloption text="No" value="N" />
						</s:dropdownlist>
					</s:div>
					<s:div name="divElement11b" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="tx_emailPoste"
							label="Email per report Poste:" maxlenght="50" showrequired="true"
							validator="required;maxlength=50"
							cssclasslabel="label85 bold textright"
							cssclass="textareaman" 
							text="${tx_emailPoste}" />
