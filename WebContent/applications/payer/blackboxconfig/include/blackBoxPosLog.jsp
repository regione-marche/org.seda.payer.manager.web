...
<s:div name="div_selezione" cssclass="div_align_center divSelezione">
	...
	<s:form name="form_selezione" action="blackboxposlog.do" method="post"
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			<s:div name="divRicercaTitleName" cssclass="divRicTitle bold">RICERCA LOG POSIZIONI BLACKBOX
			</s:div>
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">
					<s:div name="divElement9" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="tx_idEnte" 
...
<c:if test="${!empty lista_blackboxlog}">
	<s:div name="divRicercaFillName" cssclass="divRicercaFill bold">
			ELENCO LOG OPERAZIONI BLACK BOX
	</s:div>
	<s:div name="div_datagrid_log">
		<s:datagrid viewstate="" cachedrowset="lista_blackboxlog"
			action="blackboxposlog.do" border="1" usexml="true" rowperpage="${applicationScope.rowsPerPage}">
			<s:action>
			<c:url value="blackboxposlog.do">
			...
			<s:dgcolumn index="5" label="Data Inserimento"></s:dgcolumn>
			<s:dgcolumn index="6" label="Operazione Eseguita"></s:dgcolumn>
			<s:dgcolumn label="Azioni">
				<s:hyperlink
					href="blackboxposlog.do?codOp=delete&idLog={1}"
