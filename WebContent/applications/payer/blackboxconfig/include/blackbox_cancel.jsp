	...
	<s:form name="delete_form" action="blackboxEdit.do?vista=${vista}" method="post"
		...
		<s:div name="divRicMetadati" cssclass="divRicMetadati">
			<s:div name="divRicercaBottoni" cssclass="divRicBottoni">
				...
				<input type="hidden" name="tx_ente" value="${tx_enteda5}" />
				<input type="hidden" name="tx_applicationCode" value="${tx_applicationCode}" />
				...
				<input type="hidden" name="tx_codiceServizio" value="${tx_codiceServizio}" />
