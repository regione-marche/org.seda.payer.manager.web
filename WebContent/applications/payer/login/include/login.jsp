...
<div class="divLogin">
	...
	<s:form method="post" name="portal_login" action="j_signon_do"
		...
		btn1onclick="" cssclass="formLogin" autocomplete="off">
			...
			<p><s:textbox label="Username" autocomplete="off" bmodify="true" name="j_username" text="${param.j_username}" validator="required" cssclass="login_textarea_label" cssclasslabel="login_textarea_label left" /></p>
			<p><s:textbox label="Password" bpassword="true" autocomplete="off" bmodify="true" name="j_password" text="${param.j_password}" validator="required" cssclass="login_textarea_label" cssclasslabel="login_textarea_label left" /></p>
