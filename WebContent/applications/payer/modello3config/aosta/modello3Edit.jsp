...
<s:div name="div_selezione" cssclass="div_align_center divSelezione">
	...
	<s:form name="var_form" action="modello3Edit.do?vista=${vista}" method="post"
		...
		<div class="seda-ui-divvalidator"><span id="wrtMsg_message"class="seda-ui-spanvalidator"><br></span></div>
			<c:if test="${codop == 'add'}">
				<s:div name="divRicercaTitleName" cssclass="divRicTitle">CONFIGURAZIONE PAGOPA</s:div>
			</c:if>
			<c:if test="${codop == 'edit'}">
				<s:div name="divRicercaTitleName" cssclass="divRicTitle">CONFIGURAZIONE PAGOPA - ${tx_ente}</s:div>
			</c:if>
