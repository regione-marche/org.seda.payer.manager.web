...
<m:view_state id="areamercantile" encodeAttributes="true" />
...
<s:div name="div_selezione" cssclass="div_align_center divSelezione">
	...
	<s:form name="form_selezione" action="areamercantile.do?vista=areamercantile" method="post"
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			<s:div name="divRicercaTitleName" cssclass="divRicTitle bold">RICERCA CONFIGURAZIONE AREA MERCANTILE
			</s:div>
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">			
					<s:div name="divElement4" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="tx_codiceareamerc"
							label="Codice Mercato:" maxlenght="10" 
							cssclasslabel="label85 bold textright"
							cssclass="textareaman" validator="ignore;maxlength=10"
							text="${tx_codiceareamerc}" />
					</s:div>
				</s:div>
				<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">			
					<s:div name="divElement4" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="tx_desc_area"
							label="Descrizione Mercato:" maxlenght="20" 
							cssclasslabel="label85 bold textright"
			...
			<s:div name="divRicercaBottoni" cssclass="divRicBottoni">
				...
				<c:if test="${!empty lista_configurazioni_areamerc}">
...
<c:if test="${!empty lista_configurazioni_areamerc}">
	<s:div name="divRicercaFillName" cssclass="divRicercaFill bold">
			ELENCO AREE MERCANTILI
	</s:div>
	<s:div name="div_datagrid">
		<s:datagrid viewstate="" cachedrowset="lista_configurazioni_areamerc"
			action="areamercantile.do?vista=areamercantileLista" border="1" usexml="true" rowperpage="${applicationScope.rowsPerPage}">
			
			<s:dgcolumn index="5" label="Cod. Area Merc." css="text_align_left"/>
			<s:dgcolumn index="6" label="Descrizione Area Merc." css="text_align_left"/>
			...
			<s:dgcolumn label="Azioni">
				<s:hyperlink
					href="areamercantileEdit.do?vista=areamercantile&codop=edit&ddlSocietaUtenteEnte={1}|{2}|{3}&tx_area_mercantile={4}"
					imagesrc="../applications/templates/shared/img/edit.png"
					alt="Modifica" text=""
					cssclass="blacklink hlStyle" />
				<s:hyperlink
					href="areamercantileEdit.do?vista=areamercantile&tx_button_cancel=&ddlSocietaUtenteEnte={1}|{2}|{3}&tx_area_mercantile={4}"
