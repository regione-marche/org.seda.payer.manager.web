...
<m:view_state id="anagAutorizzazioneEdit" encodeAttributes="true" />
...
<s:div name="div_selezione" cssclass="div_align_center divSelezione">
	...
	<s:form name="var_form" action="anagautorizzazioneEdit.do?vista=${vista}" method="post"
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			<c:if test="${codop == 'add'}">
				<s:div name="divRicercaTitleName" cssclass="divRicTitle">CONFIGURAZIONE ANAGRAFICA AUTORIZZAZIONE</s:div>
			</c:if>
				...
				<s:div name="divRicercaMetadatiLeft" cssclass="divRicMetadatiLeft">
			            <s:div name="divElement1" cssclass="divRicMetadatiSingleRow">
						    <s:textbox bmodify="true" name="tx_anag_autorizzazione" 
				             label="Codice Autorizzzione:" showrequired="true" maxlenght="30"
							 validator="required;maxlength=30" bdisable="${codop == 'edit'}"
							 cssclasslabel="label85 bold textright" cssclass="ttextareaman"
							 text="${tx_anag_autorizzazione}" />					
						</s:div>
						<s:div name="divElement1" cssclass="divRicMetadatiSingleRow">
				            <s:textbox bmodify="true" name="tx_codfisc_autor"
								label="Codice Fiscale:" showrequired="true" maxlenght="20"
								validator="required;maxlength=20" 
								cssclasslabel="label85 bold textright"
								cssclass="textareaman"
								text="${tx_codfisc_autor}" />
						</s:div>
						<s:div name="divElement1" cssclass="divRicMetadatiSingleRow">
				            <s:textbox bmodify="true" name="tx_nominat_autor"
								label="Nominativo:" showrequired="true" maxlenght="90"
								validator="required;maxlength=90" 
								cssclasslabel="label85 bold textright"
								cssclass="textareaman"
								text="${tx_nominat_autor}" />
						</s:div>
												    
						<s:div name="divElement9" cssclass="divRicMetadatiSingleRow">
								<s:div name="divDataIniValidita" cssclass="divDataDa">
									<s:date label="Data Inizio Validit&agrave;:"  
									    prefix="tx_dval_ini" yearbegin="${ddlDateAnnoDa}"
						...
						<s:div name="divElement9" cssclass="divRicMetadatiSingleRow">
							<s:div name="divDataFinValidita" cssclass="divDataDa">
								<s:date label="Data Fine Validit&agrave;:" 
									prefix="tx_dval_fin" yearbegin="${ddlDateAnnoDa}"
			...
			<s:div name="divRicercaBottoni" cssclass="divRicBottoni">
				...
				<input type="hidden" name="tx_codicefiscanagaut_h" value="${tx_codicefiscanagaut_h}" />
	</s:form>
	</s:div>
