...
<m:view_state id="areaMercantileEdit" encodeAttributes="true" />
...
<s:div name="div_selezione" cssclass="div_align_center divSelezione">
	...
	<s:form name="var_form" action="areamercantileEdit.do?vista=${vista}" method="post"
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			<c:if test="${codop == 'add'}">
				<s:div name="divRicercaTitleName" cssclass="divRicTitle">CONFIGURAZIONE AREA MERCANTILE</s:div>
			</c:if>
			...
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">
			            <s:div name="divElement1" cssclass="divRicMetadatiSingleRow">
							<s:textbox bmodify="true" name="tx_codice_area" 
			...
			<s:div name="divRicercaBottoni" cssclass="divRicBottoni">
				...
				<input type="hidden" name="tx_codice_area_h" value="${tx_codice_area_h}" />
				<input type="hidden" name="tx_descr_area_h" value="${tx_descr_area_h}" />
				<input type="hidden" name="tx_data_ini_val_h" value="${tx_data_ini_val_h}" />
	</s:form>
	</s:div>
