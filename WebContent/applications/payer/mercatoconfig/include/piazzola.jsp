...
<m:view_state id="piazzola" encodeAttributes="true" />
...
<s:div name="div_selezione" cssclass="div_align_center divSelezione">
	...
	<s:form name="form_selezione" action="piazzola.do?vista=piazzola" method="post"
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			<s:div name="divRicercaTitleName" cssclass="divRicTitle bold">RICERCA CONFIGURAZIONE PIAZZOLA
			</s:div>
			...
			<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">			
				<s:div name="divElement4" cssclass="divRicMetadatiSingleRow">
					<s:textbox bmodify="true" name="tx_piazzola"
						label="Codice Piazzola:" maxlenght="10" 
			...
			<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">			
				<s:div name="divElement4" cssclass="divRicMetadatiSingleRow">
					<s:textbox bmodify="true" name="tx_descr_piazzola"
						label="Descr. Piazzola:" maxlenght="70" 
						cssclasslabel="label85 bold textright"
						cssclass="textareaman" validator="ignore"
			...
			<s:div name="divRicercaBottoni" cssclass="divRicBottoni">
				...
				<c:if test="${!empty lista_configurazioni_piazzola}">
...
<c:if test="${!empty lista_configurazioni_piazzola}">
	...
	<s:div name="div_datagrid">
		<s:datagrid viewstate="" cachedrowset="lista_configurazioni_piazzola"
			action="piazzola.do?vista=piazzolaLista" border="1" usexml="true" rowperpage="${applicationScope.rowsPerPage}">
			
			<s:dgcolumn index="6" label="Area Mercantile" css="text_align_left"/>
			<s:dgcolumn index="7" label="Codice Piazzola" css="text_align_left"/>
			<s:dgcolumn index="8" label="Descr. Piazzola" css="text_align_left"/>
			<s:dgcolumn index="9" label="Data Inizio Validit&agrave;" css="text_align_left"/>
			<s:dgcolumn index="10" label="Data Fine Validit&agrave;" css="text_align_left"/>
			<s:dgcolumn label="Azioni">
				<s:hyperlink
					href="piazzolaEdit.do?vista=piazzola&codop=edit&ddlSocietaUtenteEnte={1}|{2}|{3}&tx_area_mercantile={4}&tx_piazzola={7}"
					imagesrc="../applications/templates/shared/img/edit.png"
					alt="Modifica" text=""
					cssclass="blacklink hlStyle" />
				<s:hyperlink
					href="piazzolaEdit.do?vista=piazzola&tx_button_cancel=&ddlSocietaUtenteEnte={1}|{2}|{3}&tx_area_mercantile={4}&tx_key_piazzola={5}"
