...
<m:view_state id="anagautorizzazione" encodeAttributes="true" />
...
<s:div name="div_selezione" cssclass="div_align_center divSelezione">
	...
	<s:form name="form_selezione" action="anagautorizzazione.do?vista=anagautorizzazione" method="post"
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			<s:div name="divRicercaTitleName" cssclass="divRicTitle bold">RICERCA CONFIGURAZIONE ANAGRAFICA AUTORIZZAZIONE
			</s:div>
			...
			<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">			
				<s:div name="divElement4" cssclass="divRicMetadatiSingleRow">
					<s:textbox bmodify="true" name="tx_codicefiscanagaut"
						label="Cod.Fisc./P.Iva:" maxlenght="20" 
						cssclasslabel="label85 bold textright"
						cssclass="textareaman" validator="ignore"
						message="[accept=Codice Fiscale: ${msg_configurazione_descrizione_regex}]"
						text="${tx_codicefiscanagaut}" />
				</s:div>
			</s:div>
			<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">			
				<s:div name="divElement4" cssclass="divRicMetadatiSingleRow">
					<s:textbox bmodify="true" name="tx_nominatanagaut"
						label="Nominativo:" maxlenght="70" 
						cssclasslabel="label85 bold textright"
						cssclass="textareaman" validator="ignore"
						text="${tx_nominatanagaut}" />
				</s:div>
			</s:div>
			<s:div name="divRicercaRight" cssclass="divRicMetadatiRight">			
				<s:div name="divElement4" cssclass="divRicMetadatiSingleRow">
					<s:textbox bmodify="true" name="tx_anag_autorizzazione"
						label="Nm. Autorizzazione:" maxlenght="30" 
						cssclasslabel="label85 bold textright"
						cssclass="textareaman" validator="ignore"
						text="${tx_anag_autorizzazione}" /> 
				</s:div>
			</s:div>							
			<s:div name="divRicercaBottoni" cssclass="divRicBottoni">
				...
				<c:if test="${!empty lista_configurazioni_anagauto}">
...
<c:if test="${!empty lista_configurazioni_anagauto}">
	<s:div name="divRicercaFillName" cssclass="divRicercaFill bold">
			ELENCO ANAGRAFICHE AUTORIZZAZIONI
	</s:div>
	<s:div name="div_datagrid">
		<s:datagrid viewstate="" cachedrowset="lista_configurazioni_anagauto"
			action="anagautorizzazione.do?vista=anagautorizzazioneLista" border="1" usexml="true" rowperpage="${applicationScope.rowsPerPage}">
			<s:dgcolumn index="4" label="Num. Autorizzazione" css="text_align_left"/>
			<s:dgcolumn index="5" label="Codice Fiscale" css="text_align_left"/>
			<s:dgcolumn index="6" label="Nominativo Collegato" css="text_align_left"/>
			...
			<s:dgcolumn label="Azioni">
				<s:hyperlink
					href="anagautorizzazioneEdit.do?vista=anagautorizzazione&codop=edit&ddlSocietaUtenteEnte={1}|{2}|{3}&tx_anag_autorizzazione={4}"
					imagesrc="../applications/templates/shared/img/edit.png"
					alt="Modifica" text=""
					cssclass="blacklink hlStyle" />
				<s:hyperlink
					href="anagautorizzazioneEdit.do?vista=anagautorizzazione&tx_button_cancel=&ddlSocietaUtenteEnte={1}|{2}|{3}&tx_anag_autorizzazione={4}"
