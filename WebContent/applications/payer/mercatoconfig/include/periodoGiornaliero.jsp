...
<m:view_state id="periodogiornaliero" encodeAttributes="true" />
...
<s:div name="div_selezione" cssclass="div_align_center divSelezione">
	...
	<s:form name="form_selezione" action="periodogiornaliero.do?vista=periodogiornaliero" method="post"
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			<s:div name="divRicercaTitleName" cssclass="divRicTitle bold">RICERCA CONFIGURAZIONE PERIODO GIORNALIERO
			</s:div>
			<s:div name="divRicMetadati" cssclass="divRicMetadati">
				...
				<s:div name="divRicercaLeft" cssclass="divRicMetadatiLeft">			
					<s:div name="divElement4" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="tx_periodo_giorn"
							label="Codice Periodo:" maxlenght="10" 
				...
				<s:div name="divRicercaCenter" cssclass="divRicMetadatiCenter">			
					<s:div name="divElement4" cssclass="divRicMetadatiSingleRow">
						<s:textbox bmodify="true" name="tx_desc_per"
							label="Descrizione Periodo:" maxlenght="20" 
							cssclasslabel="label85 bold textright"
			...
			<s:div name="divRicercaBottoni" cssclass="divRicBottoni">
				...
				<c:if test="${!empty lista_configurazioni_pergiorn}">
...
<c:if test="${!empty lista_configurazioni_pergiorn}">
	<s:div name="divRicercaFillName" cssclass="divRicercaFill bold">
			ELENCO PERIODO GIORNALIERO
	</s:div>
	<s:div name="div_datagrid">
		<s:datagrid viewstate="" cachedrowset="lista_configurazioni_pergiorn"
			action="periodogiornaliero.do?vista=periodogiornalieroLista" border="1" usexml="true" rowperpage="${applicationScope.rowsPerPage}">
			
			<s:dgcolumn index="4" label="Cod. Periodo Giorn." css="text_align_left"/>
			<s:dgcolumn index="5" label="Descrizione Periodo Giornaliero" css="text_align_left"/>
			<s:dgcolumn label="Azioni">
				<s:hyperlink
					href="periodogiornalieroEdit.do?vista=periodogiornaliero&codop=edit&ddlSocietaUtenteEnte={1}|{2}|{3}&tx_periodo_giorn={4}"
					imagesrc="../applications/templates/shared/img/edit.png"
					alt="Modifica" text=""
					cssclass="blacklink hlStyle" />
				<s:hyperlink
					href="periodogiornalieroEdit.do?vista=periodogiornaliero&tx_button_cancel=&ddlSocietaUtenteEnte={1}|{2}|{3}&tx_periodo_giorn={4}"
