	...
	<s:form name="delete_form" action="piazzolaEdit.do?vista=${vista}" method="post"
		...
		<s:div name="divRicMetadati" cssclass="divRicMetadati">
			<s:div name="divRicercaBottoni" cssclass="divRicBottoni">
				...
				<input type="hidden" name="tx_key_piazzola_h" value="${tx_key_piazzola_h}" />	
