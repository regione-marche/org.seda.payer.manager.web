...
<s:div name="divSitoIstituzionaleContent" cssclass="divSitoIstituzionaleContent">
	...
	<p>
		...
		Il Titolare del trattamento dei dati personali di cui alla presente Informativa è Regione Marche, via Gentile da Fabriano, 9 - 60125 Ancona <br />
		...
		Regione Marche, in qualità di Titolare del trattamento, è tenuta a fornirle informazioni in merito all'utilizzo dei suoi dati personali.  
	</p>
	<p>
	...
	<p>
		...
		dal Titolare o dai Responsabili del trattamento. Regione Marche impartirà le opportune istruzioni scritte ai soggetti che opereranno 
		...
		del servizio di pagamento selezionato da Regione Marche ai fini del corretto svolgimento del relativo procedimento per il raggiungimento 
