...
<m:view_state id="raccordopagonet" encodeAttributes="true" />
...
<s:div name="div_selezione" cssclass="div_align_center divSelezione">
	...
	<s:form name="form_selezione" action="raccordopagonet.do?vista=raccordopagonet" method="post"
...
<c:if test="${!empty lista_configurazioni_evoluzioni}">
	...
	<s:div name="div_datagrid">
		<s:datagrid viewstate="" cachedrowset="lista_configurazioni_evoluzioni"
			action="raccordopagonet.do?vista=raccordopagonetLista" border="1" usexml="true" rowperpage="${applicationScope.rowsPerPage}">
			
			<s:dgcolumn index="7" label="Societ&agrave;" css="text_align_left"/>
			<s:dgcolumn index="6" label="Utente" css="text_align_left"/>
			<s:dgcolumn index="5" label="Ente" css="text_align_left"/>
			<s:dgcolumn index="8" label="Tipologia Servizio" css="text_align_left"/>
			<s:dgcolumn label="Azioni">
				<s:hyperlink
					href="raccordopagonetEdit.do?vista=raccordopagonet&codop=edit&ddlSocietaUtenteEnte={1}|{2}|{3}&tx_tipologia_servizio={4}&tx_ordine_scuola={5}"
					imagesrc="../applications/templates/shared/img/edit.png"
					alt="Modifica" text=""
					cssclass="blacklink hlStyle" />
				<s:hyperlink
					href="raccordopagonetEdit.do?vista=raccordopagonet&tx_button_cancel=&ddlSocietaUtenteEnte={1}|{2}|{3}&tx_tipologia_servizio={4}&tx_ordine_scuola={5}"
