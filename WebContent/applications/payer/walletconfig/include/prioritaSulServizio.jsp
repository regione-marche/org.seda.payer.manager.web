...
<m:view_state id="prioritasulservizio" encodeAttributes="true" />
...
<s:div name="div_selezione" cssclass="div_align_center divSelezione">
	...
	<s:form name="form_selezione" action="prioritasulservizio.do?vista=prioritasulservizio" method="post"
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			<s:div name="divRicercaTitleName" cssclass="divRicTitle bold">RICERCA CONFIGURAZIONE PRIORITA' ATTRIBUZIONE SUL SERVIZIO
			</s:div>
...
<c:if test="${!empty lista_configurazioni_evoluzioni}">
	<s:div name="divRicercaFillName" cssclass="divRicercaFill bold">
			ELENCO PRIORITA' ATTRIBUZIONI SUL SERVIZIO
	</s:div>
	<s:div name="div_datagrid">
		<s:datagrid viewstate="" cachedrowset="lista_configurazioni_evoluzioni"
			action="prioritasulservizio.do?vista=prioritasulservizioLista" border="1" usexml="true" rowperpage="${applicationScope.rowsPerPage}">
			
			<s:dgcolumn index="6" label="Servizio" css="text_align_left"></s:dgcolumn>
			<s:dgcolumn index="7" label="Priorit&agrave;" css="text_align_left" ></s:dgcolumn>
			<s:dgcolumn index="8" label="Priorit&agrave; Attr. 1" css="text_align_left" ></s:dgcolumn>
			<s:dgcolumn index="9" label="Priorit&agrave; Attr. 2" css="text_align_left" ></s:dgcolumn>
			<s:dgcolumn index="10" label="Priorit&agrave; Attr. 3" css="text_align_left" ></s:dgcolumn>

			
			<s:dgcolumn label="Azioni">
				<s:hyperlink
					href="prioritasulservizioEdit.do?vista=prioritasulservizio&codop=edit&ddlSocietaUtenteEnte={1}|{2}|{3}&tx_tipologia_servizio={4}&tx_priorita={7}"
					imagesrc="../applications/templates/shared/img/edit.png"
					alt="Modifica" text=""
					cssclass="blacklink hlStyle" />
				<s:hyperlink
					href="prioritasulservizioEdit.do?vista=prioritasulservizio&tx_button_cancel=&ddlSocietaUtenteEnte={1}|{2}|{3}&tx_tipologia_servizio={4}&tx_priorita={7}"
