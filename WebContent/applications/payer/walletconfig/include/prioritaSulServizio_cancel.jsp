...
<m:view_state id="prioritasulservizio_cancel" encodeAttributes="true" />


<s:div name="div_delete" cssclass="div_align_center divSelezione">
	<s:div name="divDeleteTopName" cssclass="divRicercaTop">
	<s:form name="delete_form" action="prioritasulservizioEdit.do?vista=${vista}" method="post"
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
		<s:div name="divRicercaTitleName" cssclass="divRicTitle bold">
		CANCELLAZIONE PRIORITA' ATTRIBUZIONI SUL SERVIZIO
		</s:div>
		<br/>
		<br/>
		<s:div name="divRicMetadati" cssclass="divRicMetadati">
			<s:div name="divRicercaBottoni" cssclass="divRicBottoni">
				...
				<input type="hidden" name="tx_codice_tributo_h" value="${tx_codice_tributo_h}" />
				<input type="hidden" name="tx_priorita" value="${tx_priorita}" />
