...
<m:view_state id="pagamentoperservizio" encodeAttributes="true" />
...
<s:div name="div_selezione" cssclass="div_align_center divSelezione">
	...
	<s:form name="form_selezione" action="pagamentoperservizio.do?vista=pagamentoperservizio" method="post"
		hasbtn1="false" hasbtn2="false" hasbtn3="false">
			<s:div name="divRicercaTitleName" cssclass="divRicTitle bold">RICERCA CONFIGURAZIONE PAGAMENTO PER SERVIZIO
			</s:div>
...
<c:if test="${!empty lista_configurazioni_evoluzioni}">
	...
	<s:div name="div_datagrid">
		<s:datagrid viewstate="" cachedrowset="lista_configurazioni_evoluzioni"
			action="pagamentoperservizio.do?vista=evoluzioneintimazioniLista" border="1" usexml="true" rowperpage="${applicationScope.rowsPerPage}">
			
			<s:dgcolumn index="6" label="Servizio" />
			<s:dgcolumn index="5" label="Priorit&agrave;" css="text_align_left" ></s:dgcolumn>
			<s:dgcolumn index="8" label="Ente" css="text_align_left" ></s:dgcolumn>
			<s:dgcolumn index="9" label="Imposta Servizio" css="text_align_left" ></s:dgcolumn>
			<s:dgcolumn label="Azioni">
				<s:hyperlink
					href="pagamentoperservizioEdit.do?vista=pagamentoperservizio&codop=edit&ddlSocietaUtenteEnte={1}|{2}|{3}&tx_tipologia_servizio={4}"
					imagesrc="../applications/templates/shared/img/edit.png"
					alt="Modifica" text=""
					cssclass="blacklink hlStyle" />
				<s:hyperlink
					href="pagamentoperservizioEdit.do?vista=pagamentoperservizio&tx_button_cancel=&ddlSocietaUtenteEnte={1}|{2}|{3}&tx_tipologia_servizio={4}"
