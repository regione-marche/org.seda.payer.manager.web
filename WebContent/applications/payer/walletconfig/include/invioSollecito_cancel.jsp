...
<m:view_state id="inviosollecito_cancel" encodeAttributes="true" />


<s:div name="div_delete" cssclass="div_align_center divSelezione">
	<s:div name="divDeleteTopName" cssclass="divRicercaTop">
	<s:form name="delete_form" action="inviosollecitoEdit.do?vista=${vista}" method="post"
		...
		<s:div name="divRicMetadati" cssclass="divRicMetadati">
			<s:div name="divRicercaBottoni" cssclass="divRicBottoni">
				...
				<input type="hidden" name="tx_dval_sms" value="${tx_dval_sms}" />
				<input type="hidden" name="tx_tipo_sms" value="${tx_tipo_sms}" />				
	</s:form>
</s:div>
