...
//            $('#ici_versamento_saldo',clone).html((ici.flag_rata == '1' || ici.flag_rata == '3')?'Si':'No');
        ...
        if (jsonObject.listDettaglioOnere != null && jsonObject.listDettaglioOnere.length > 0)
        {
            var colLabels = "Ente Destinatario$$Beneficiario<br />[Cod.Utente - Cod.Ente - Tp.Uff - Cod.Uff]$$Importo Totale$$Causale".split("$$");
            var keys = "descrizioneEntePortaleEsterno$$beneficiario$$importoTotale$$causale".split("$$");
