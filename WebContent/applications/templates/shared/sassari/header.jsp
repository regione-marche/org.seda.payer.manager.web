...
<s:div name="divCommonHeader" cssclass="HeaderSassari">

	
	<s:image src="../applications/templates/shared/sassari/img/logo_sassari.jpg" width="79" height="78" alt="Sassari" cssclass="logomondo posleft block" />
