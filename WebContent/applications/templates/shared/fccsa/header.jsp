...
<s:div name="divCommonHeader" cssclass="HeaderFccsa">
	<s:image src="../applications/templates/shared/fccsa/img/logo-fccsa.jpg" width="250" height="93" alt="Farmacia Comunale Città di Sant'Angelo" cssclass="logomondo posleft block" />
