...
<m:setBundle name="org.seda.payer.manager.resources.TemplateStrings" />
 ...
 <s:div name="divFooterContainer" cssclass="divFooterContainer">
	 <s:div name="divFooterLeft" cssclass="footerLeft">
	 	<s:image src="../applications/templates/shared/img/LogoFooterRM.gif" alt="MPay Regione Marche" width="111" height="35" cssclass="imgLogoFooterLepida" />
	 </s:div>
	 <s:div name="divFooterRight" cssclass="footerRight">
		 ...
		 <s:div name="divFooterSociale" cssclass="footersociale"> <m:message key="footer.message.regmarche"/></s:div>
	</s:div>
 </s:div> 
