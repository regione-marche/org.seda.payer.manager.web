...
<s:div name="divCommonHeader" cssclass="HeaderRoseto">
	<s:image src="../applications/templates/shared/roseto/img/rosetoHeaderLogo.png" width="70" height="97" alt="Roseto degli Abruzzi" cssclass="logomondo posleft block" />
