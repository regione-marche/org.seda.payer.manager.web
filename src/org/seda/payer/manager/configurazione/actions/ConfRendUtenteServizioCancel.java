...
public class ConfRendUtenteServizioCancel extends BaseManagerAction{
	...
	public Object service(HttpServletRequest request) throws ActionException {
		...
		case TX_BUTTON_DELETE:
			ConfRendUtenteServizioCancelRequestType in = new ConfRendUtenteServizioCancelRequestType();
			...
			try {
				ConfRendUtenteServizioCancelResponseType out = WSCache.confRendUtenteServizioServer.cancel(in, request);
				if (out != null)
				{
