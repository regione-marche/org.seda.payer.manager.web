package org.seda.payer.manager.configurazione.flows;
	...
	import org.seda.payer.manager.configurazione.actions.GestioneConvenzioneImpAction;
	...
	public class GestioneConvenzioneImpFlow extends GestioneConvenzioneImpAction implements FlowManager {
		...
		public String process(HttpServletRequest request) throws FlowException {
			...
			//				setErrorMessage(request, fte.getMessage1());
						...
						catch (RemoteException re)
						{
							...
							re.printStackTrace();
			//				setErrorMessage(request, fte.getMessage1());
							setFormMessage("ricercaConvImpForm", testoErroreColl, request);
