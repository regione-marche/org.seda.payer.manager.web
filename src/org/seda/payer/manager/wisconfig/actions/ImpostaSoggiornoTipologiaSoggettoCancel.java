...
public class ImpostaSoggiornoTipologiaSoggettoCancel extends BaseManagerAction{
	...
	public Object service(HttpServletRequest request) throws ActionException {
		...
		case TX_BUTTON_DELETE:
			...
			CancellaTipologiaSoggettoRequest cancelRequest = new CancellaTipologiaSoggettoRequest();
			cancelRequest.setTipologiaSoggetto(tipoSoggetto);
			try {
				CancellaTipologiaSoggettoResponse out = WSCache.impostaSoggiornoConfigServer.cancellaTipologiaSoggetti(cancelRequest, request);
