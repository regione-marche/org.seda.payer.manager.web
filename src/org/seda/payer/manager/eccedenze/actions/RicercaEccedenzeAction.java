...
import com.seda.payer.eccedenze.webservice.dati.Paginazione;
import com.seda.payer.eccedenze.webservice.dati.RecuperaRimborsiRequest;
import com.seda.payer.eccedenze.webservice.dati.RecuperaRimborsiResponse;

public class RicercaEccedenzeAction extends BaseEccedenzeAction {
    ...
    public void ricercaEccedenze(HttpServletRequest request) throws Exception
    {
			...
			out =  WSCache.eccedenzeServer.recuperaRimborsi(in, request);
