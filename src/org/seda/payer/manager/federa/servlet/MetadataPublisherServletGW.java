...
public class MetadataPublisherServletGW extends HttpServlet
{
    ...
    public MetadataPublisherServletGW()
    {
        metadataFile = null;
    ...
    {
        metadataFile = config.getServletContext().getRealPath(config.getServletContext().getInitParameter("metadataFileGW"));
