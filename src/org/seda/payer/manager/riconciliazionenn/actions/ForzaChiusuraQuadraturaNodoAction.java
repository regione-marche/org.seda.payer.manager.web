...
public class ForzaChiusuraQuadraturaNodoAction extends BaseRiconciliazioneNodoAction {
...
//		setProfile(request);
		...
		if (chiaveMovimento != null) {
			...
			try {
				...
				RecuperaMovimentiApertiNodoResponse movimentiCBI = getListaMovimentiAperti(request);
