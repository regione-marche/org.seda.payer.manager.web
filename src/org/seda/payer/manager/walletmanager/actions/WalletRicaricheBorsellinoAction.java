...
public class WalletRicaricheBorsellinoAction extends WalletBaseManagerAction {
					...
					if (walletPageListlist.getRetCode()!="00") {
						...
						if(pageInfo != null)
						{
							if(pageInfo.getNumRows() > 0)
							{
								...
								request.setAttribute("lista_walletricaricheborsellino_riepilogo", walletRiepilogoListXml);
							}
