...
public class UserEditAction2 extends BaseAdminusersAction  implements PayerCommand{
	...
	public Object execute(HttpServletRequest request) throws PayerCommandException {
		...
		switch(firedButton)
		{
			...
			case TX_BUTTON_EDIT:  
				...
				getAdd1ParametersFromSession(request,session);
				String esito = checkSeUtenteEsistente(request);
				if(esito.equals("OK"))
					modificaUtente(request, session, "var2_form", false, false);
				else
					setFormMessage("var2_form", esito, request);
	...
	public void modificaUtente(HttpServletRequest request, HttpSession session, String sFormName, boolean bPYCO, boolean bOperatore)
	{
